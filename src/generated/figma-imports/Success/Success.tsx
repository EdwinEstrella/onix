import svgPaths from "./svg-u7ztjpje55";
import imgImg from "./26831184183db0fa75a765cd0fd0ea9443c6185a.png";
import { imgDecoration } from "./svg-e4rgd";
    ...
    <div className="h-[1061.155px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-98.057px_-263.293px] mask-size-[720px_1000px] relative w-[1158.875px]" style={{ maskImage: `url('${imgDecoration}')` }} data-name="decoration">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1158.87 1061.15">
        <g id="decoration">
          ...
          <path d={svgPaths.p2d4d0640} id="circle 1" stroke="url(#paint0_radial_6_31408)" strokeOpacity="0.7" strokeWidth="80" data-figma-bg-blur-radius="10" />
          ...
          <path d={svgPaths.p32982400} id="circle 2" stroke="url(#paint1_radial_6_31408)" strokeOpacity="0.65" strokeWidth="60" data-figma-bg-blur-radius="10" />
          <path d={svgPaths.p40d0b80} id="circle 3" stroke="url(#paint2_radial_6_31408)" strokeOpacity="0.81" strokeWidth="80" />
          <ellipse cx="1133.44" cy="75.0571" fill="url(#paint3_linear_6_31408)" id="Ellipse 8" rx="25.4325" ry="25.4711" />
        </g>
        <defs>
          <radialGradient cx="0" cy="0" gradientTransform="matrix(14.8999 706.331 -705.26 14.9225 514.873 553.79)" gradientUnits="userSpaceOnUse" id="paint0_radial_6_31408" r="1">
            <stop offset="0.654764" stopColor="#2E37A4" />
            <stop offset="1" stopColor="#2E37A4" stopOpacity="0.8" />
          </radialGradient>
          <radialGradient cx="0" cy="0" gradientTransform="matrix(12.0647 571.928 -571.061 12.083 517.708 547.241)" gradientUnits="userSpaceOnUse" id="paint1_radial_6_31408" r="1">
            <stop offset="0.654764" stopColor="#E2F6FC" stopOpacity="0.36" />
            <stop offset="1" stopColor="#2E37A4" stopOpacity="0.8" />
          </radialGradient>
          <radialGradient cx="0" cy="0" gradientTransform="matrix(9.65173 457.543 -456.849 9.66639 520.121 543.473)" gradientUnits="userSpaceOnUse" id="paint2_radial_6_31408" r="1">
            <stop offset="0.654764" stopColor="#E2F6FC" stopOpacity="0.36" />
            <stop offset="1" stopColor="#48B7D6" stopOpacity="0" />
          </radialGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_6_31408" x1="1158.87" x2="1107.93" y1="100.528" y2="49.6633">
...
function CheckboxContainer() {
  return (
    <div className="bg-[#27ae60] content-stretch flex items-center p-[12px] relative rounded-[50px] shrink-0" data-name="Checkbox Container">
  ...
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 text-center w-full" data-name="Sign In Text Container">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#0a1b39] text-[20px] w-full">
        <p className="leading-[24px]">Success</p>
      </div>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] opacity-70 relative shrink-0 text-[#6c7688] text-[14px] w-full">Your new password has been successfully saved.</p>
    </div>
  );
}
      ...
      <div className="bg-[#2e37a4] h-[38px] relative rounded-[6px] shrink-0 w-full" data-name="Button">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] py-[8px] relative size-full">
            <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Back to Login</p>
          </div>
        </div>
      </div>
    </div>
...
export default function Success() {
  return (
    <div className="bg-[#f5f6f8] relative size-full" data-name="Success">
      <ImageContainer />
      <FormSection />
    </div>
  );
