import svgPaths from "./svg-m6kz6l18qx";
import imgImage2 from "./0bc68fa0411b7ed793c78af09c4e1617ea56f94c.png";
import imgImage3 from "./237d88852d6286e4d794d595e89e2f70335b0544.png";
import imgImage4 from "./a4c763821182afa4e32c5d3f89298dc63f0a9c98.png";
import imgImage5 from "./a714ad9790d4ec085214aa123201a18b03894086.png";
import imgImage6 from "./880e93c8aeeeab7e637be3f3b16b2918627c2c46.png";
import imgImage7 from "./b73c3a3953059da8a62866023be63595f2980841.png";
import imgImage8 from "./90fbae3a29fe5e5c2270251f73f9db7bac98a963.png";
import imgImage9 from "./579fe8e5ecffd5de7626d8aba0b266f9849b885a.png";
import imgImage10 from "./ea4b32ea18c99f2dc808021626b0dae9a8addd6e.png";
import imgImage11 from "./9bf5dab7e488e532587856c42ea3ca7fbda1ea0f.png";
import imgImage12 from "./2575725d0b9d6fc275732822d84198ce2700ceb2.png";
import imgImage13 from "./8a4f379e58823833baa895f664e56273d669a658.png";
import imgImage14 from "./84fe07240696ab3d323dc924f3b98f5bc2ec8e5d.png";
import imgImage15 from "./dc689e5e857312b88301dc7109f2f0b74d92536c.png";
import imgImage16 from "./e15e49d17669796cbf6bf8bf3e6cf50b666a1f39.png";
import imgAvatarCircle from "./e11f5284f9aaa3e4330ba42e90f83be1f5843642.png";

function Footer() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between px-[24px] py-[8px] right-0 top-[1104px] w-[1164px]" data-name="Footer">
...
function TitleContainer() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-[339px]" data-name="Title Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[24px] not-italic relative shrink-0 text-[#0a1b39] text-[20px] whitespace-nowrap">Doctor Grid</p>
      <div className="bg-[#ecedf7] content-stretch flex h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
        <div aria-hidden="true" className="absolute border border-[#2e37a4] border-solid inset-[-0.5px] pointer-events-none rounded-[6.5px]" />
        <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#2e37a4] text-[13px] whitespace-nowrap">
          <p className="leading-[19.5px]">Total Doctors : 565</p>
        </div>
      </div>
    </div>
  );
...
function ListView() {
  return (
    <div className="content-stretch flex items-center p-[5px] relative rounded-[6px] shrink-0" data-name="List View">
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="list">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
          <g id="Vector" />
        </svg>
        <div className="absolute bottom-3/4 left-[37.5%] right-[16.67%] top-1/4" data-name="Vector">
          <div className="absolute inset-[-0.5px_-7.79%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.41667 1">
              <path d="M0.5 0.5H6.91667" id="Vector" stroke="var(--stroke-0, #6B7280)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute bottom-1/2 left-[37.5%] right-[16.67%] top-1/2" data-name="Vector">
          <div className="absolute inset-[-0.5px_-7.79%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.41667 1">
              <path d="M0.5 0.5H6.91667" id="Vector" stroke="var(--stroke-0, #6B7280)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        ...
        <div className="absolute bottom-1/4 left-[37.5%] right-[16.67%] top-3/4" data-name="Vector">
          <div className="absolute inset-[-0.5px_-7.79%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.41667 1">
              <path d="M0.5 0.5H6.91667" id="Vector" stroke="var(--stroke-0, #6B7280)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        ...
        <div className="absolute bottom-[74.96%] left-[20.83%] right-[79.17%] top-1/4" data-name="Vector">
          <div className="absolute inset-[-0.5px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 1.00583">
              <path d="M0.5 0.5V0.505833" id="Vector" stroke="var(--stroke-0, #6B7280)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute bottom-[49.96%] left-[20.83%] right-[79.17%] top-1/2" data-name="Vector">
          <div className="absolute inset-[-0.5px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 1.00583">
              <path d="M0.5 0.5V0.505833" id="Vector" stroke="var(--stroke-0, #6B7280)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        ...
        <div className="absolute bottom-[24.96%] left-[20.83%] right-[79.17%] top-3/4" data-name="Vector">
          <div className="absolute inset-[-0.5px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 1.00583">
              <path d="M0.5 0.5V0.505833" id="Vector" stroke="var(--stroke-0, #6B7280)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
...
function ListView1() {
  return (
    <div className="bg-[#f5f6f8] content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex items-center p-[5px] relative rounded-[5px] shrink-0" data-name="List View">
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="layout-grid">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
          <g id="Vector" />
        </svg>
        <div className="absolute inset-[16.67%_58.33%_58.33%_16.67%]" data-name="Vector">
          <div className="absolute inset-[-14.29%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4.5 4.5">
              <path d={svgPaths.p3d338500} id="Vector" stroke="var(--stroke-0, #0A1B39)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
...
function GridView() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Grid View">
      <ListView />
      <ListView1 />
    </div>
  );
...
function HeaderActions() {
  return (
    <div className="content-stretch flex gap-[12px] items-center justify-end relative shrink-0 w-[614px]" data-name="Header Actions">
      ...
      <div className="bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex gap-[4px] items-center p-[4px] relative rounded-[6px] shrink-0" data-name="Grid">
        <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-[7px]" />
        <GridView />
      </div>
      <div className="bg-[#2e37a4] content-stretch flex gap-[4px] items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
        ...
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[19.5px] not-italic relative shrink-0 text-[13px] text-center text-white whitespace-nowrap">New Doctor</p>
      </div>
    </div>
  );
}
...
function ImageContainer() {
  return (
    <div className="bg-white overflow-clip relative rounded-[6px] shrink-0 size-[120px]" data-name="Image Container">
      <div className="absolute left-0 size-[120px] top-0" data-name="image 2">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[133.33%] left-[-41.25%] max-w-none top-0 w-[200%]" src={imgImage2} />
        </div>
      </div>
    </div>
  );
...
function Designation() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Designation">
...
function ActionContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Action Container">
...
function Availability() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Availability">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[0px] whitespace-nowrap">
        <span className="leading-[19.5px] text-[13px]">{`Available : Mon, `}</span>
        <span className="leading-[19.5px] text-[13px]">20</span>
        <span className="leading-[19.5px] text-[13px]">{` Jan 2025`}</span>
      </p>
    </div>
  );
}
...
function Price() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-w-px not-italic relative whitespace-nowrap" data-name="Price">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#6c7688] text-[13px]">{`Starts From : `}</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] relative shrink-0 text-[#2e37a4] text-[14px]">$499</p>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="content-stretch flex gap-[12px] items-end relative shrink-0 w-full" data-name="Container">
      <Price />
      <div className="bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex items-center p-[4px] relative rounded-[6px] shrink-0" data-name="Component 2">
        <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-[7px]" />
        <div className="overflow-clip relative shrink-0 size-[14px]" data-name="calendar-cog">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
            <g id="Vector" />
          </svg>
          <div className="absolute inset-[20.83%_16.67%_12.5%_16.67%]" data-name="Vector">
            <div className="absolute inset-[-5.36%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.3333 10.3333">
                <path d={svgPaths.p3ec53170} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[12.5%_33.33%_70.83%_66.67%]" data-name="Vector">
            <div className="absolute inset-[-21.43%_-0.5px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 3.33333">
                <path d="M0.5 0.5V2.83333" id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          ...
          <div className="absolute inset-[45.83%_16.67%_54.17%_16.67%]" data-name="Vector">
            <div className="absolute inset-[-0.5px_-5.36%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.3333 1">
                <path d="M0.5 0.5H9.83333" id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[70.83%_12.5%_12.5%_70.84%]" data-name="Vector">
            <div className="absolute inset-[-21.43%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3.33333 3.33333">
                <path d={svgPaths.p398b4b00} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[64.58%_20.83%_29.17%_79.17%]" data-name="Vector">
            <div className="absolute inset-[-57.14%_-0.5px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 1.875">
                <path d="M0.5 0.5V1.375" id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          ...
          <div className="absolute bottom-1/4 left-[86.39%] right-[8.2%] top-[71.88%]" data-name="Vector">
            <div className="absolute inset-[-114.3%_-66%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.75792 1.43767">
                <path d={svgPaths.p2e2de980} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[83.33%_28.04%_13.54%_66.54%]" data-name="Vector">
            <div className="absolute inset-[-114.3%_-65.95%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.7585 1.43767">
                <path d={svgPaths.pfe59200} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute bottom-1/4 left-[66.54%] right-[28.04%] top-[71.88%]" data-name="Vector">
            <div className="absolute inset-[-114.3%_-65.95%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.7585 1.43767">
                <path d={svgPaths.p17304180} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
...
function Container() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-w-px relative self-stretch" data-name="Container">
      <ImageContainer />
      <Container1 />
    </div>
  );
...
function MainContainer1() {
  return (
    <div className="bg-white flex-[1_0_0] h-[160px] min-w-px relative rounded-[6px]" data-name="Main Container">
...
function DoctorCardContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-w-px relative" data-name="Doctor Card Container">
      <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative rounded-[6px]" data-name="Doctor Card">
    ...
    <div className="bg-white overflow-clip relative rounded-[6px] shrink-0 size-[120px]" data-name="Image Container">
      <div className="absolute left-0 size-[120px] top-0" data-name="image 2">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          ...
          <img alt="" className="absolute max-w-none object-cover size-full" src={imgImage3} />
        </div>
      </div>
    </div>
  );
...
function Availability1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Availability">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[0px] whitespace-nowrap">
        <span className="leading-[19.5px] text-[13px]">{`Available : Wed, `}</span>
        <span className="leading-[19.5px] text-[13px]">22</span>
        <span className="leading-[19.5px] text-[13px]">{` Jan 2025`}</span>
      </p>
    </div>
  );
...
function Price1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-w-px not-italic relative whitespace-nowrap" data-name="Price">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#6c7688] text-[13px]">{`Starts From : `}</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] relative shrink-0 text-[#2e37a4] text-[14px]">$450</p>
    </div>
  );
}
...
function Availability2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Availability">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[0px] whitespace-nowrap">
        <span className="leading-[19.5px] text-[13px]">{`Available : Fri, `}</span>
        <span className="leading-[19.5px] text-[13px]">24</span>
        <span className="leading-[19.5px] text-[13px]">{` Jan 2025`}</span>
      </p>
    </div>
  );
...
function Price2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-w-px not-italic relative whitespace-nowrap" data-name="Price">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#6c7688] text-[13px]">{`Starts From : `}</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] relative shrink-0 text-[#2e37a4] text-[14px]">$300</p>
    </div>
  );
}
...
function DoctorRow() {
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full" data-name="Doctor Row">
      <DoctorCardContainer />
      <DoctorCardContainer1 />
      <DoctorCardContainer2 />
    </div>
  );
}
    ...
    <div className="bg-white overflow-clip relative rounded-[6px] shrink-0 size-[120px]" data-name="Image Container">
      <div className="absolute left-0 size-[120px] top-0" data-name="image 2">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <img alt="" className="absolute h-[149.86%] left-0 max-w-none top-[-11.6%] w-full" src={imgImage5} />
          </div>
        </div>
      </div>
    </div>
...
function Availability3() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Availability">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[0px] whitespace-nowrap">
        <span className="leading-[19.5px] text-[13px]">{`Available : Tue, `}</span>
        <span className="leading-[19.5px] text-[13px]">21</span>
        <span className="leading-[19.5px] text-[13px]">{` Jan 2025`}</span>
      </p>
    </div>
  );
...
function Price3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-w-px not-italic relative whitespace-nowrap" data-name="Price">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#6c7688] text-[13px]">{`Starts From : `}</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] relative shrink-0 text-[#2e37a4] text-[14px]">$250</p>
    </div>
  );
}
...
function Availability4() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Availability">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[0px] whitespace-nowrap">
        <span className="leading-[19.5px] text-[13px]">{`Available : Mon, `}</span>
        <span className="leading-[19.5px] text-[13px]">27</span>
        <span className="leading-[19.5px] text-[13px]">{` Jan 2025`}</span>
      </p>
    </div>
  );
...
function Price4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-w-px not-italic relative whitespace-nowrap" data-name="Price">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#6c7688] text-[13px]">{`Starts From : `}</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] relative shrink-0 text-[#2e37a4] text-[14px]">$350</p>
    </div>
  );
}
    ...
    <div className="bg-white overflow-clip relative rounded-[6px] shrink-0 size-[120px]" data-name="Image Container">
      <div className="absolute left-0 size-[120px] top-0" data-name="image 2">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          ...
          <img alt="" className="absolute max-w-none object-cover size-full" src={imgImage7} />
        </div>
      </div>
    </div>
  );
...
function Availability5() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Availability">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Available : Thu, Jan 30, 2025</p>
    </div>
  );
}
...
function Price5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-w-px not-italic relative whitespace-nowrap" data-name="Price">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#6c7688] text-[13px]">{`Starts From : `}</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] relative shrink-0 text-[#2e37a4] text-[14px]">$700</p>
    </div>
  );
}
...
function DoctorRow1() {
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full" data-name="Doctor Row">
      <DoctorCardContainer3 />
      <DoctorCardContainer4 />
      <DoctorCardContainer5 />
    </div>
  );
}
...
function Availability6() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Availability">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[0px] whitespace-nowrap">
        <span className="leading-[19.5px] text-[13px]">{`Available : Sat, `}</span>
        <span className="leading-[19.5px] text-[13px]">25</span>
        <span className="leading-[19.5px] text-[13px]">{` Jan 2025`}</span>
      </p>
    </div>
  );
...
function Price6() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-w-px not-italic relative whitespace-nowrap" data-name="Price">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#6c7688] text-[13px]">{`Starts From : `}</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] relative shrink-0 text-[#2e37a4] text-[14px]">$200</p>
    </div>
  );
}
...
function Availability7() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Availability">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Available : Sun, 01 Feb 2025</p>
    </div>
  );
}
...
function Container55() {
  return (
    <div className="content-stretch flex gap-[12px] items-end relative shrink-0 w-full" data-name="Container">
      <Price7 />
      <div className="bg-[#f5f6f8] content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex items-center p-[4px] relative rounded-[6px] shrink-0" data-name="Component 2">
        <div className="overflow-clip relative shrink-0 size-[14px]" data-name="calendar-cog">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
            <g id="Vector" />
          </svg>
          <div className="absolute inset-[20.83%_16.67%_12.5%_16.67%]" data-name="Vector">
            <div className="absolute inset-[-5.36%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.3333 10.3333">
                <path d={svgPaths.p3ec53170} id="Vector" stroke="var(--stroke-0, #0A1B39)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[12.5%_33.33%_70.83%_66.67%]" data-name="Vector">
...
function DoctorCardContainer7() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-[358.333px]" data-name="Doctor Card Container">
      <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative rounded-[6px]" data-name="Doctor Card">
        <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-[7px] shadow-[0px_4px_20px_0px_rgba(92,92,92,0.08)]" />
        <MainContainer8 />
      </div>
    </div>
  );
    ...
    <div className="bg-white overflow-clip relative rounded-[6px] shrink-0 size-[120px]" data-name="Image Container">
      <div className="absolute left-0 size-[120px] top-0" data-name="image 2">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          ...
          <img alt="" className="absolute max-w-none object-cover size-full" src={imgImage10} />
        </div>
      </div>
    </div>
  );
...
function Availability8() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Availability">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[0px] whitespace-nowrap">
        <span className="leading-[19.5px] text-[13px]">{`Available : Tue, `}</span>
        <span className="leading-[19.5px] text-[13px]">28</span>
        <span className="leading-[19.5px] text-[13px]">{` Jan 2025`}</span>
      </p>
    </div>
  );
...
function Price8() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-w-px not-italic relative whitespace-nowrap" data-name="Price">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#6c7688] text-[13px]">{`Starts From : `}</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] relative shrink-0 text-[#2e37a4] text-[14px]">$400</p>
    </div>
  );
}
...
function DoctorRow2() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-full" data-name="Doctor Row">
      <DoctorCardContainer6 />
      <DoctorCardContainer7 />
      <DoctorCardContainer8 />
    </div>
  );
}
...
function Availability9() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Availability">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Available : Thu, 05 Feb 2025</p>
    </div>
  );
}
    ...
    <div className="bg-white overflow-clip relative rounded-[6px] shrink-0 size-[120px]" data-name="Image Container">
      <div className="absolute left-0 size-[120px] top-0" data-name="image 2">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <img alt="" className="absolute h-full left-[-4.9%] max-w-none top-0 w-[149.8%]" src={imgImage12} />
          </div>
        </div>
      </div>
    </div>
...
function Designation10() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Designation">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Surgeon</p>
    </div>
  );
}
...
function Availability10() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Availability">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Available : Mon, 09 Feb 2025</p>
    </div>
  );
}
...
function Price10() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-w-px not-italic relative whitespace-nowrap" data-name="Price">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#6c7688] text-[13px]">{`Starts From : `}</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] relative shrink-0 text-[#2e37a4] text-[14px]">$500</p>
    </div>
  );
}
...
function DoctorCardContainer10() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-w-px relative" data-name="Doctor Card Container">
      <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative rounded-[6px]" data-name="Doctor Card">
        <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-[7px] shadow-[0px_1px_1px_0px_rgba(0,0,0,0.05)]" />
    ...
    <div className="bg-white overflow-clip relative rounded-[6px] shrink-0 size-[120px]" data-name="Image Container">
      <div className="absolute left-0 size-[120px] top-0" data-name="image 2">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          ...
          <img alt="" className="absolute max-w-none object-cover size-full" src={imgImage13} />
        </div>
      </div>
    </div>
  );
...
function Name11() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Name">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Dr. Adrian White</p>
    </div>
  );
}

function Designation11() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Designation">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Practitioner</p>
    </div>
  );
}
...
function Availability11() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Availability">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Available : Sat, 25 Jan 2025</p>
    </div>
  );
}
...
function DoctorCardContainer11() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-w-px relative" data-name="Doctor Card Container">
      <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative rounded-[6px]" data-name="Doctor Card">
        <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-[7px] shadow-[0px_1px_1px_0px_rgba(0,0,0,0.05)]" />
...
function DoctorRow3() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-full" data-name="Doctor Row">
      <DoctorCardContainer9 />
      <DoctorCardContainer10 />
      <DoctorCardContainer11 />
    </div>
  );
}
    ...
    <div className="bg-white overflow-clip relative rounded-[6px] shrink-0 size-[120px]" data-name="Image Container">
      <div className="absolute left-0 size-[120px] top-0" data-name="image 2">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          ...
          <img alt="" className="absolute max-w-none object-cover size-full" src={imgImage8} />
          <div className="absolute inset-0 overflow-hidden">
            <img alt="" className="absolute h-full left-[-10.02%] max-w-none top-0 w-[146.71%]" src={imgImage14} />
          </div>
        </div>
      </div>
    </div>
...
function Name12() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Name">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Dr. Ken Clark</p>
    </div>
  );
}

function Designation12() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Designation">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Dermatologist</p>
    </div>
  );
}
...
function Availability12() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Availability">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[0px] whitespace-nowrap">
        <span className="leading-[19.5px] text-[13px]">{`Available : Wed, `}</span>
        <span className="leading-[19.5px] text-[13px]">12</span>
        <span className="leading-[19.5px] text-[13px]">{` Feb 2025`}</span>
      </p>
    </div>
  );
}
...
function DoctorCardContainer12() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-w-px relative" data-name="Doctor Card Container">
      <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative rounded-[6px]" data-name="Doctor Card">
        <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-[7px] shadow-[0px_1px_1px_0px_rgba(0,0,0,0.05)]" />
    ...
    <div className="bg-white overflow-clip relative rounded-[6px] shrink-0 size-[120px]" data-name="Image Container">
      <div className="absolute left-0 size-[120px] top-0" data-name="image 2">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          ...
          <img alt="" className="absolute max-w-none object-cover size-full" src={imgImage10} />
          <img alt="" className="absolute max-w-none object-cover size-full" src={imgImage15} />
        </div>
      </div>
    </div>
  );
...
function Name13() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Name">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Dr. Oliver King</p>
    </div>
  );
}

function Designation13() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Designation">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Orthopedist</p>
    </div>
  );
}
...
function Availability13() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Availability">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[0px] whitespace-nowrap">
        <span className="leading-[19.5px] text-[13px]">{`Available : Fri, `}</span>
        <span className="leading-[19.5px] text-[13px]">14</span>
        <span className="leading-[19.5px] text-[13px]">{` Feb 2025`}</span>
      </p>
    </div>
  );
...
function Price13() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-w-px not-italic relative whitespace-nowrap" data-name="Price">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#6c7688] text-[13px]">{`Starts From : `}</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] relative shrink-0 text-[#2e37a4] text-[14px]">$600</p>
    </div>
  );
}
...
function DoctorCardContainer13() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-w-px relative" data-name="Doctor Card Container">
      <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative rounded-[6px]" data-name="Doctor Card">
        <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-[7px] shadow-[0px_1px_1px_0px_rgba(0,0,0,0.05)]" />
    ...
    <div className="bg-white overflow-clip relative rounded-[6px] shrink-0 size-[120px]" data-name="Image Container">
      <div className="absolute left-0 size-[120px] top-0" data-name="image 2">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          ...
          <img alt="" className="absolute max-w-none object-cover size-full" src={imgImage9} />
          <div className="absolute inset-0 overflow-hidden">
            <img alt="" className="absolute h-full left-[-26.67%] max-w-none top-0 w-[150%]" src={imgImage16} />
          </div>
        </div>
      </div>
    </div>
...
function Name14() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Name">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Dr. Avan Davis</p>
    </div>
  );
}

function Designation14() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Designation">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Endocrinologist</p>
    </div>
  );
}
...
function Availability14() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Availability">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[0px] whitespace-nowrap">
        <span className="leading-[19.5px] text-[13px]">{`Available : Tue, `}</span>
        <span className="leading-[19.5px] text-[13px]">17</span>
        <span className="leading-[19.5px] text-[13px]">{` Feb 2025`}</span>
      </p>
    </div>
  );
...
function Price14() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-w-px not-italic relative whitespace-nowrap" data-name="Price">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#6c7688] text-[13px]">{`Starts From : `}</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] relative shrink-0 text-[#2e37a4] text-[14px]">$375</p>
    </div>
  );
}
...
function DoctorCardContainer14() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-w-px relative" data-name="Doctor Card Container">
      <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative rounded-[6px]" data-name="Doctor Card">
        <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-[7px] shadow-[0px_1px_1px_0px_rgba(0,0,0,0.05)]" />
...
function DoctorRow4() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-full" data-name="Doctor Row">
      <DoctorCardContainer12 />
      <DoctorCardContainer13 />
      <DoctorCardContainer14 />
    </div>
  );
}

function DoctorCardsContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Doctor Cards Container">
      <DoctorRow />
      <DoctorRow1 />
      <DoctorRow2 />
      <DoctorRow3 />
...
function ContentContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center justify-center relative shrink-0 w-full" data-name="Content Container">
      ...
      <div className="bg-white content-stretch flex gap-[4px] items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
        ...
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[19.5px] not-italic relative shrink-0 text-[#0a1b39] text-[13px] text-center whitespace-nowrap">Load More</p>
        <div className="overflow-clip relative shrink-0 size-[13px]" data-name="loader-2">
          <div className="absolute inset-[12.5%]" data-name="Vector">
            <div className="absolute inset-[-10.26%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.75 11.75">
                <path d={svgPaths.pa58f000} id="Vector" stroke="var(--stroke-0, #0A1B39)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
              </svg>
            </div>
          </div>
        </div>
...
function MainContainer() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-center left-[295px] top-[76px] w-[1116px]" data-name="Main Container">
      <HeaderContainer />
      <ContentContainer />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Menu Name">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] relative size-full">
          <Gift1 />
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">Doctor Details</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Menu Name">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] relative size-full">
          <Gift2 />
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#2e37a4] text-[14px] whitespace-nowrap">Add Doctor</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="bg-white relative shrink-0 w-full" data-name="Header">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between px-[20px] py-[15px] relative size-full">
          <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[20px] whitespace-nowrap">
            <p className="leading-[24px]">New Doctor</p>
          </div>
            ...
            <div className="absolute inset-1/4" data-name="Vector">
              <div className="absolute inset-[-6.25%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 9">
                  <path d="M8.5 0.5L0.5 8.5" id="Vector" stroke="var(--stroke-0, #0A1B39)" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
            <div className="absolute inset-1/4" data-name="Vector">
              <div className="absolute inset-[-6.25%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 9">
                  <path d="M0.5 0.5L8.5 8.5" id="Vector" stroke="var(--stroke-0, #0A1B39)" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
          </div>
...
function SectionHeader() {
  return (
    <div className="bg-[#f5f6f8] relative shrink-0 w-full" data-name="Section Header">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[20px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[16px] whitespace-nowrap">
            <p className="leading-[19.2px]">Contact Information</p>
          </div>
        </div>
      </div>
    </div>
...
function MaskGroup() {
  return (
    <div className="absolute contents left-0 right-0 top-0" data-name="Mask group">
      <div className="absolute aspect-[100/100] left-0 right-0 top-0" data-name="Avatar Circle">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 72 72">
          <circle cx="36" cy="36" fill="var(--fill-0, #F5F6F8)" id="image" r="36" />
        </svg>
      </div>
    </div>
  );
...
function InputBlank() {
  return (
    <div className="content-stretch flex gap-[40px] h-[97.01px] items-center relative shrink-0 w-[372px]" data-name="Input Blank">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Profile Image</p>
      <div className="h-[72.01px] relative shrink-0 w-[72px]">
        <MaskGroup />
        <div className="absolute inset-[49.99%_9.05%_0_0.31%]" data-name="Subtract">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 65.264 36.0111">
            <path d={svgPaths.p313bdf00} fill="var(--fill-0, #030303)" fillOpacity="0.8" id="Subtract" />
          </svg>
        </div>
        <div className="-translate-x-1/2 absolute left-1/2 overflow-clip size-[10px] top-[60px]" data-name="photo">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
            <g id="Vector" />
          </svg>
          <div className="absolute inset-[33.33%_37.46%_66.67%_62.5%]" data-name="Vector">
            <div className="absolute inset-[-0.5px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.00417 1">
                <path d="M0.5 0.5H0.504167" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[12.5%]" data-name="Vector">
            <div className="absolute inset-[-6.67%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.5 8.5">
                <path d={svgPaths.p1d08980} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[43.04%_33.33%_33.33%_12.5%]" data-name="Vector">
            <div className="absolute inset-[-21.16%_-9.23%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.41667 3.3624">
                <path d={svgPaths.p274ac380} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[51.38%_12.5%_33.33%_58.33%]" data-name="Vector">
            <div className="absolute inset-[-32.7%_-17.14%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3.91667 2.52906">
                <path d={svgPaths.p3e8a7e80} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
        </div>
        <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 overflow-clip size-[14px] top-[calc(50%-0.01px)]" data-name="user-plus">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
            <g id="Vector" />
          </svg>
          <div className="absolute inset-[12.5%_33.33%_54.17%_33.33%]" data-name="Vector">
            <div className="absolute inset-[-10.71%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.66667 5.66667">
                <path d={svgPaths.p1333fe00} id="Vector" stroke="var(--stroke-0, #9DA4B0)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[79.17%_8.33%_20.83%_66.67%]" data-name="Vector">
            <div className="absolute inset-[-0.5px_-14.29%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4.5 1">
                <path d="M0.5 0.5H4" id="Vector" stroke="var(--stroke-0, #9DA4B0)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[66.67%_20.83%_8.33%_79.17%]" data-name="Vector">
            <div className="absolute inset-[-14.29%_-0.5px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 4.5">
                <path d="M0.5 0.5V4" id="Vector" stroke="var(--stroke-0, #9DA4B0)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute bottom-[12.5%] left-1/4 right-[41.67%] top-[62.5%]" data-name="Vector">
            <div className="absolute inset-[-14.29%_-10.71%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.66667 4.5">
                <path d={svgPaths.p1eec9100} id="Vector" stroke="var(--stroke-0, #9DA4B0)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
        </div>
    ...
    <div className="bg-white drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] h-[36px] relative rounded-[6px] shrink-0 w-full" data-name="Input">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[12px] py-[6px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal h-full justify-center leading-[0] min-w-px not-italic relative text-[#0a1b39] text-[14px]">
            <p className="leading-[21px]">Andrew</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Input Row">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input Blank">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">
          <span className="leading-[21px]">{`Name `}</span>
      ...
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input Blank">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">
          <span className="leading-[21px]">Username</span>
          <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px]">{` `}</span>
          <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] text-[#ef1e1e]">*</span>
        </p>
        <Input1 />
      </div>
    </div>
...
function InputRow1() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Input Row">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input Blank">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">
          <span className="leading-[21px]">{`Phone Number `}</span>
          <span className="leading-[21px] text-[#ef1e1e]">*</span>
        </p>
        <Input2 />
      </div>
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input Blank">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">
          <span className="leading-[21px]">Email Address</span>
          <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px]">{` `}</span>
          <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] text-[#ef1e1e]">*</span>
        </p>
        <Input3 />
...
function InputContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="Input Container">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with date">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">DOB</p>
        <Input4 />
      </div>
    </div>
  );
...
function InputRow2() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Input Row">
      <InputContainer />
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input Blank">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Year Of Experience</p>
        <Input5 />
      </div>
    </div>
  );
...
function SelectOption1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-full items-center justify-between min-w-px relative" data-name="Select Option">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal h-full justify-center leading-[0] min-w-px not-italic relative text-[#0a1b39] text-[14px]">
        <p className="leading-[21px]">Cardiologist</p>
      </div>
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="chevron-down">
        <div className="absolute bottom-[37.5%] left-1/4 right-1/4 top-[37.5%]" data-name="Vector">
          <div className="absolute inset-[-14.29%_-7.14%]">
...
function InputRow3() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Input Row">
      ...
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with Select">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">
          <span className="leading-[21px]">Designation</span>
          <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px]">{` `}</span>
          <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] text-[#ef1e1e]">*</span>
        </p>
        <Input7 />
    ...
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Tags">
      <div className="bg-[#f5f6f8] content-stretch flex gap-[4px] h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-bl-[6px] rounded-br-[4px] rounded-tl-[6px] rounded-tr-[4px] shrink-0" data-name="Badge">
        ...
        <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[13px] whitespace-nowrap">
          <p className="leading-[19.5px]">English</p>
        </div>
      ...
      <div className="bg-[#f5f6f8] content-stretch flex gap-[4px] h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-bl-[6px] rounded-br-[4px] rounded-tl-[6px] rounded-tr-[4px] shrink-0" data-name="Badge">
        <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-[-0.5px] pointer-events-none rounded-bl-[6.5px] rounded-br-[4.5px] rounded-tl-[6.5px] rounded-tr-[4.5px]" />
        <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[13px] whitespace-nowrap">
          <p className="leading-[19.5px]">French</p>
        </div>
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="x">
          <div className="absolute inset-1/4" data-name="Vector">
            <div className="absolute inset-[-8.33%]">
...
function InputRow4() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Input Row">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input Blank">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">
          <span className="leading-[21px]">{`Medical License Number `}</span>
          <span className="leading-[21px] text-[#ef1e1e]">*</span>
        </p>
        <Input8 />
      </div>
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input Multi select">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Language Spoken</p>
        <Input9 />
      </div>
    </div>
  );
...
function InputRow5() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Input Row">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with Select">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Blood Group</p>
        <Input10 />
      </div>
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with Select">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Gender</p>
        <Input11 />
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-white drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] h-[80px] relative rounded-[6px] shrink-0 w-full" data-name="Input">
      ...
      <div className="content-stretch flex items-start px-[12px] py-[6px] relative size-full">
        <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[#9da4b0] text-[14px]">
          <p className="leading-[21px]">About Doctor</p>
        </div>
      </div>
    </div>
  );
...
function FeatureToggleRow() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0" data-name="Feature Toggle Row">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">Feature On Website</p>
      <button className="bg-[#27ae60] content-stretch cursor-pointer flex h-[16px] items-center justify-end p-[4px] relative rounded-[8px] shrink-0 w-[30px]" data-name="Switcher">
        <div className="bg-white h-[8px] rounded-[6px] shrink-0 w-[7.991px]" />
      </button>
    </div>
  );
}
...
function FormContent1() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Form Content">
      <InputBlank />
      <InputRow />
      <InputRow1 />
      <InputRow2 />
      ...
      <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Textarea">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Bio</p>
        <Input12 />
      </div>
      <FeatureToggleRow />
    </div>
...
function FormContent() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Form Content">
      <FormContent1 />
    </div>
  );
}
...
function FormSection() {
  return (
    <div className="relative shrink-0 w-full" data-name="Form Section">
  ...
  return (
    <div className="bg-[#f5f6f8] relative shrink-0 w-full" data-name="Section Header">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[20px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[16px] whitespace-nowrap">
            <p className="leading-[19.2px]">Address Information</p>
          </div>
        </div>
      </div>
    </div>
...
function InputRow6() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Input Row">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input Blank">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Address 1</p>
        <Input13 />
      </div>
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input Blank">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">
          <span className="leading-[21px]">Address 2</span>
          <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px]">{` `}</span>
        </p>
        <Input14 />
      </div>
...
function InputContainer2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="Input Container">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with Select">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Country</p>
        <Input15 />
      </div>
    </div>
  );
...
function InputContainer1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-w-px relative" data-name="Input Container">
      <InputContainer2 />
    </div>
  );
}
...
function InputContainer4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="Input Container">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with Select">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">City</p>
        <Input16 />
      </div>
    </div>
  );
...
function InputContainer5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-w-px relative" data-name="Input Container">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with Select">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">State</p>
        <Input17 />
      </div>
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input Blank">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Pincode</p>
        <Input18 />
      </div>
    </div>
  );
...
function InputRow8() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Input Row">
      <InputContainer5 />
    </div>
  );
}
...
function InputColumn() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Input Column">
      <InputRow7 />
      <InputRow8 />
    </div>
  );
  ...
  return (
    <div className="bg-[#f5f6f8] relative shrink-0 w-full" data-name="Section Header">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[20px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[16px] whitespace-nowrap">
            <p className="leading-[19.2px]">Appointment Schedule</p>
          </div>
        </div>
      </div>
    </div>
...
function ButtonRow() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Button Row">
      <div className="bg-[#2e37a4] content-stretch flex items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] not-italic relative shrink-0 text-[13px] text-center text-white whitespace-nowrap">Monday</p>
      </div>
      <div className="bg-[#f5f6f8] content-stretch flex items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] not-italic relative shrink-0 text-[#0a1b39] text-[13px] text-center whitespace-nowrap">Tuesday</p>
      </div>
      <div className="bg-[#f5f6f8] content-stretch flex items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] not-italic relative shrink-0 text-[#0a1b39] text-[13px] text-center whitespace-nowrap">Wednesday</p>
      </div>
      <div className="bg-[#f5f6f8] content-stretch flex items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] not-italic relative shrink-0 text-[#0a1b39] text-[13px] text-center whitespace-nowrap">Thursday</p>
      </div>
      <div className="bg-[#f5f6f8] content-stretch flex items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] not-italic relative shrink-0 text-[#0a1b39] text-[13px] text-center whitespace-nowrap">Friday</p>
      </div>
      <div className="bg-[#f5f6f8] content-stretch flex items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] not-italic relative shrink-0 text-[#0a1b39] text-[13px] text-center whitespace-nowrap">Saturday</p>
      </div>
      <div className="bg-[#f5f6f8] content-stretch flex items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] not-italic relative shrink-0 text-[#0a1b39] text-[13px] text-center whitespace-nowrap">Sunday</p>
      </div>
    </div>
  );
}
...
function Time() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-full items-center justify-between min-w-px relative" data-name="Time">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal h-full justify-center leading-[0] min-w-px not-italic relative text-[#0a1b39] text-[14px]">
        <p className="leading-[21px] whitespace-pre-wrap">{`03 : 05  AM`}</p>
      </div>
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="clock-hour-10">
        <div className="absolute inset-[12.5%]" data-name="Vector">
          <div className="absolute inset-[-4.76%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.5 11.5">
              <path d={svgPaths.p33bbbb00} id="Vector" stroke="var(--stroke-0, #0A1B39)" strokeLinecap="round" strokeLinejoin="round" />
        ...
        <div className="absolute bottom-1/2 left-[37.5%] right-1/2 top-[41.67%]" data-name="Vector">
          <div className="absolute inset-[-42.86%_-28.57%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2.75011 2.16677">
              <path d={svgPaths.p38295000} id="Vector" stroke="var(--stroke-0, #0A1B39)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute bottom-1/2 left-1/2 right-1/2 top-[29.17%]" data-name="Vector">
          <div className="absolute inset-[-17.14%_-0.5px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 3.91667">
              <path d="M0.5 0.5V3.41667" id="Vector" stroke="var(--stroke-0, #0A1B39)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      </div>
...
function Time1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-full items-center justify-between min-w-px relative" data-name="Time">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal h-full justify-center leading-[0] min-w-px not-italic relative text-[#9da4b0] text-[14px]">
        <p className="leading-[21px] whitespace-pre-wrap">{`-- : --  --`}</p>
      </div>
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="clock-hour-10">
        <div className="absolute inset-[12.5%]" data-name="Vector">
          <div className="absolute inset-[-4.76%]">
...
function InputContainer7() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-w-px relative" data-name="Input Container">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with Time">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">From</p>
        <Input20 />
      </div>
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with Time">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">To</p>
        <Input21 />
      </div>
    </div>
  );
...
function InputContainer6() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-[661px]" data-name="Input Container">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with Select">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Session</p>
        <Input19 />
      </div>
      <InputContainer7 />
    </div>
...
function AddButtonContainer() {
  return (
    <div className="bg-[#f5f6f8] content-stretch flex items-center p-[10px] relative rounded-[6px] shrink-0" data-name="Add Button Container">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Add Icon">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
          <g id="Vector" />
        </svg>
        <div className="absolute bottom-[20.83%] left-1/2 right-1/2 top-[20.83%]" data-name="Vector">
...
function InputRow9() {
  return (
    <div className="content-stretch flex gap-[16px] items-end relative shrink-0 w-full" data-name="Input Row">
      <InputContainer6 />
      <AddButtonContainer />
    </div>
  );
...
function DeleteButtonContainer() {
  return (
    <div className="bg-[#fef4f4] content-stretch flex items-center p-[10px] relative rounded-[6px] shrink-0" data-name="Delete Button Container">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Delete Icon">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
          <g id="Vector" />
        </svg>
        <div className="absolute inset-[29.17%_16.67%_70.83%_16.67%]" data-name="Vector">
          <div className="absolute inset-[-0.5px_-4.69%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.6667 1">
              <path d="M0.5 0.5H11.1667" id="Vector" stroke="var(--stroke-0, #EF1E1E)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[45.83%_58.33%_29.17%_41.67%]" data-name="Vector">
          <div className="absolute inset-[-12.5%_-0.5px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 5">
              <path d="M0.5 0.5V4.5" id="Vector" stroke="var(--stroke-0, #EF1E1E)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        ...
        <div className="absolute inset-[29.17%_20.83%_12.5%_20.83%]" data-name="Vector">
          <div className="absolute inset-[-5.36%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.3334 10.3334">
              <path d={svgPaths.p17e5f780} id="Vector" stroke="var(--stroke-0, #EF1E1E)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[12.5%_37.5%_70.83%_37.5%]" data-name="Vector">
          <div className="absolute inset-[-18.75%_-12.5%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 3.66667">
              <path d={svgPaths.p2567ddc0} id="Vector" stroke="var(--stroke-0, #EF1E1E)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      </div>
...
function InputColumn2() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center relative shrink-0 w-full" data-name="Input Column">
      <InputColumn3 />
      <div className="bg-[#030303] content-stretch flex items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] not-italic relative shrink-0 text-[13px] text-center text-white whitespace-nowrap">Apply All</p>
      </div>
    </div>
  );
}

function InputColumn1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Input Column">
      <InputColumn2 />
    </div>
  );
}
  ...
  return (
    <div className="bg-[#f5f6f8] relative shrink-0 w-full" data-name="Section Header">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[20px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[16px] whitespace-nowrap">
            <p className="leading-[19.2px]">Appointment Information</p>
          </div>
        </div>
      </div>
    </div>
...
function SelectOption9() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-full items-center justify-between min-w-px relative" data-name="Select Option">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal h-full justify-center leading-[0] min-w-px not-italic relative text-[#0a1b39] text-[14px]">
        <p className="leading-[21px]">Online Consultation</p>
      </div>
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="chevron-down">
        <div className="absolute bottom-[37.5%] left-1/4 right-1/4 top-[37.5%]" data-name="Vector">
          <div className="absolute inset-[-14.29%_-7.14%]">
...
function InputContainer10() {
  return (
    <div className="content-stretch flex items-start relative shrink-0" data-name="Input Container">
      <div className="content-stretch flex flex-col gap-[4px] h-[61px] items-start relative shrink-0 w-[322px]" data-name="Input with Select">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Appointment Type</p>
        <Input25 />
      </div>
    </div>
  );
...
function Input26() {
  return (
    <div className="bg-white flex-[1_0_0] h-[36px] min-w-px relative rounded-bl-[6px] rounded-tl-[6px]" data-name="Input">
      <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-bl-[7px] rounded-tl-[7px]" />
      <div className="flex flex-row items-center justify-end size-full">
        <div className="content-stretch flex items-center justify-end px-[12px] py-[6px] size-full" />
      </div>
    </div>
  );
}
...
function Input27() {
  return (
    <div className="bg-white content-stretch flex h-[36px] items-center justify-end px-[12px] py-[6px] relative rounded-br-[6px] rounded-tr-[6px] shrink-0" data-name="Input">
      <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-br-[7px] rounded-tr-[7px]" />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
        <p className="leading-[21px]">Days</p>
      </div>
    </div>
  );
}
...
function InputField() {
  return (
    <div className="content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex items-start relative shrink-0 w-full" data-name="Input Field">
      <Input26 />
      <Input27 />
    </div>
  );
...
function Input29() {
  return (
    <div className="bg-white content-stretch flex h-[36px] items-center justify-end px-[12px] py-[6px] relative rounded-br-[6px] rounded-tr-[6px] shrink-0" data-name="Input">
      <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-br-[7px] rounded-tr-[7px]" />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
        <p className="leading-[21px]">Mins</p>
      </div>
    </div>
  );
}
...
function InputRow11() {
  return (
    <div className="content-stretch flex gap-[20px] items-start relative shrink-0 w-full" data-name="Input Row">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative self-stretch" data-name="Input with option Tag">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Accept bookings (in Advance)</p>
        <InputField />
      </div>
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with option Tag">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Appointment Duration</p>
        <InputField1 />
      </div>
    </div>
  );
...
function InputRow12() {
  return (
    <div className="content-stretch flex gap-[20px] items-start relative shrink-0 w-full" data-name="Input Row">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative self-stretch" data-name="Input with option Tag">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Consultation Charge</p>
        <InputField2 />
      </div>
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input Blank">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Max Bookings Per Slot</p>
        <Input32 />
      </div>
    </div>
  );
...
function DisplayToggleRow() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0" data-name="Display Toggle Row">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">Display on Booking Page</p>
      <button className="bg-[#27ae60] content-stretch cursor-pointer flex h-[16px] items-center justify-end p-[4px] relative rounded-[8px] shrink-0 w-[30px]" data-name="Switcher">
        <div className="bg-white h-[8px] rounded-[6px] shrink-0 w-[7.991px]" />
      </button>
    </div>
  ...
  return (
    <div className="bg-[#f5f6f8] relative shrink-0 w-full" data-name="Section Header">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[20px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[16px] whitespace-nowrap">
            <p className="leading-[19.2px]">Educational Information</p>
          </div>
        </div>
      </div>
    </div>
...
function InputContainer11() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-w-px relative" data-name="Input Container">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input Blank">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Educational Degree</p>
        <Input33 />
      </div>
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input Blank">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">University</p>
        <Input34 />
      </div>
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with date">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">From</p>
...
function DeleteButtonContainer1() {
  return (
    <div className="bg-[#fef4f4] content-stretch flex items-center p-[10px] relative rounded-[6px] shrink-0" data-name="Delete Button Container">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Delete Icon">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
  ...
  return (
    <div className="bg-[#f5f6f8] relative shrink-0 w-full" data-name="Section Header">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[20px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[16px] whitespace-nowrap">
            <p className="leading-[19.2px]">{`Awards & Recognition`}</p>
          </div>
        </div>
      </div>
    </div>
...
function InputContainer13() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-w-px relative" data-name="Input Container">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input Blank">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Name</p>
        <Input41 />
      </div>
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with date">
  ...
  return (
    <div className="bg-[#f5f6f8] relative shrink-0 w-full" data-name="Section Header">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[20px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[16px] whitespace-nowrap">
            <p className="leading-[19.2px]">Certifications</p>
          </div>
        </div>
      </div>
    </div>
...
function FormContainer() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Form Container">
      <FormContainer1 />
    </div>
  );
}
...
function ButtonRow1() {
  return (
    <div className="content-stretch flex gap-[12px] items-center justify-end relative shrink-0 w-[760px]" data-name="Button Row">
      <div className="bg-[#f5f6f8] content-stretch flex items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
      ...
      <div className="bg-[#2e37a4] content-stretch flex items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] not-italic relative shrink-0 text-[13px] text-center text-white whitespace-nowrap">Add Doctor</p>
      </div>
    </div>
  );
}
...
function MainContainer16() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Main Container">
      <Header />
      <SectionHeader />
      <FormContainer />
      <Footer1 />
...
function Popup() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[640px] top-0 w-[800px]" data-name="Popup">
      <MainContainer16 />
    </div>
  );
}
...
export default function AddNewDoctor() {
  return (
    <div className="bg-[#f5f6f8] relative size-full" data-name="Add New Doctor">
      <Footer />
      <MainContainer />
      ...
      <SidebarScroll />
      <div className="absolute backdrop-blur-[3px] bg-[rgba(3,3,3,0.5)] h-[2607px] left-0 top-0 w-[1440px]" data-name="Overlay" />
      <Popup />
    </div>
  );
}