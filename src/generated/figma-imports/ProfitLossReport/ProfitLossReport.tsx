import svgPaths from "./svg-1c33kj6nl8";
...
function ExpensesTitleContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[339px]" data-name="Expenses Title Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[24px] not-italic relative shrink-0 text-[#0a1b39] text-[20px] whitespace-nowrap">{`Profit & Loss Report`}</p>
    </div>
  );
}
...
function CardBody() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start justify-center min-w-px not-italic relative whitespace-nowrap" data-name="Card Body">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#6c7688] text-[14px]">Total Income</p>
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[19.2px] relative shrink-0 text-[#0a1b39] text-[16px]">$125,150</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#2e37a4] content-stretch flex items-center justify-center p-[12px] relative rounded-[50px] shrink-0" data-name="Card Icon Container">
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Card Icon">
        ...
        <div className="absolute bottom-[35.27%] left-[35.27%] right-1/4 top-1/4" data-name="Vector">
          <div className="absolute inset-[-10.49%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.536 11.536">
              <path d="M1 10.536L10.536 1" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
        <div className="absolute bottom-[58.33%] left-[58.33%] right-1/4 top-1/4" data-name="Vector">
          <div className="absolute inset-[-25%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
              <path d="M5 5V1H1" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[62.4%_62.6%_20.94%_20.73%]" data-name="Vector">
          <div className="absolute inset-[-25%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
              <path d={svgPaths.p27ab5080} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
      </div>
...
function CardFooter() {
  return (
    <div className="bg-[#f5f6f8] relative rounded-[4px] shrink-0 w-full" data-name="Card Footer">
...
function CardBody1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start justify-center min-w-px not-italic relative whitespace-nowrap" data-name="Card Body">
      ...
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[19.2px] relative shrink-0 text-[#0a1b39] text-[16px]">$91,800</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#27ae60] content-stretch flex items-center p-[12px] relative rounded-[50px] shrink-0" data-name="Card Icon Container">
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Card Icon">
        ...
        <div className="absolute bottom-1/4 left-[35.27%] right-1/4 top-[35.27%]" data-name="Vector">
          <div className="absolute inset-[-10.49%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.536 11.536">
              <path d="M1 1L10.536 10.536" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
        <div className="absolute bottom-1/4 left-[58.33%] right-1/4 top-[58.33%]" data-name="Vector">
          <div className="absolute inset-[-25%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
              <path d="M1 5H5V1" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[20.73%_62.4%_62.6%_20.94%]" data-name="Vector">
          <div className="absolute inset-[-25%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
              <path d={svgPaths.p27be1480} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
      </div>
...
function CardBody2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start justify-center min-w-px not-italic relative whitespace-nowrap" data-name="Card Body">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#6c7688] text-[14px]">Net Profit</p>
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[19.2px] relative shrink-0 text-[#0a1b39] text-[16px]">$91,800</p>
    </div>
  );
}
        ...
        <div className="absolute bottom-1/4 left-[29.17%] right-[29.17%] top-1/4" data-name="Vector">
          <div className="absolute inset-[-8.33%_-10%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 14">
              <path d={svgPaths.p1cd14d00} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
        <div className="absolute bottom-[12.5%] left-1/2 right-1/2 top-[12.5%]" data-name="Vector">
          <div className="absolute inset-[-5.56%_-1px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2 20">
              <path d="M1 1V4M1 16V19" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
      </div>
...
function CardBody3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start justify-center min-w-px not-italic relative whitespace-nowrap" data-name="Card Body">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#6c7688] text-[14px]">Profit Margin (%)</p>
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[19.2px] relative shrink-0 text-[#0a1b39] text-[16px]">26.6%</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#ef1e1e] content-stretch flex items-center p-[12px] relative rounded-[50px] shrink-0" data-name="Card Icon Container">
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Card Icon">
        ...
        <div className="absolute inset-[37.5%_12.5%_20.83%_29.17%]" data-name="Vector">
          <div className="absolute inset-[-10%_-7.14%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 12">
              <path d={svgPaths.pd011a30} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
        <div className="absolute bottom-[33.33%] left-1/2 right-[33.33%] top-1/2" data-name="Vector">
          <div className="absolute inset-[-25%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
              <path d={svgPaths.p361777c0} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[20.83%_29.17%_37.5%_12.5%]" data-name="Vector">
          <div className="absolute inset-[-10%_-7.14%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 12">
              <path d={svgPaths.p2793b0a0} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
      </div>
...
function TableRow() {
  return (
    <div className="bg-white h-[45px] relative shrink-0 w-full" data-name="Table Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-r border-solid inset-0 pointer-events-none" />
...
function TableRow1() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
  ...
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Consultation Fees</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Lab Revenue</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Pharmacy Sales</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Gross Profit</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Doctor Payouts</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Staff Salaries</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">{`Rent & Utilities`}</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Medical Supplies</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Lab Consumables</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">{`Maintenance & Repair`}</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Total Expense</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Net Income</p>
          </div>
        </div>
      </div>
    </div>
...
function TableColumn() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[284px]" data-name="Table Column">
      <TableRow />
      <TableRow1 />
      <TableRow2 />
      <TableRow3 />
...
function RowValue() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Row Value">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Jan 2025</p>
    </div>
  );
}
...
function RowValue1() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Row Value">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">$25,750</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">$50,125</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">$75,900</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">$151,775</p>
          </div>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
  ...
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">$15,000</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">$99,999</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">$2,69,276</p>
          </div>
        </div>
      </div>
    </div>
...
function RowValue2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Row Value">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Feb 2025</p>
    </div>
  );
}
  ...
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">$20,800</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">$2,75,638</p>
          </div>
        </div>
      </div>
    </div>
...
function RowValue4() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Row Value">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Mar 2025</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">$2,51,629</p>
          </div>
        </div>
      </div>
    </div>
...
function RowValue6() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Row Value">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Apr 2025</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">$7,96,543</p>
          </div>
        </div>
      </div>
    </div>
...
function RowValue8() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Row Value">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">May 2025</p>
    </div>
  );
}
...
function RowValue10() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Row Value">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Total</p>
    </div>
  );
}
...
function RowValue11() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Row Value">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Table Row">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">$87,650</p>
          </div>
        </div>
      </div>
    </div>
...
function TableHeader() {
  return (
    <div className="bg-white content-stretch flex h-[717px] items-center justify-center relative shrink-0 w-full" data-name="Table Header">
...
function TableContainer() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Table Container">
      <TableHeader />
    </div>
  );
}

function ProfitLossReportContainer() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[300px] top-[76px] w-[1116px]" data-name="Profit & Loss Report Container">
      <HeaderContainer />
      <TableContainer />
    </div>
  );
...
export default function ProfitLossReport() {
  return (
    <div className="bg-[#f5f6f8] relative size-full" data-name="Profit & Loss Report">
      <Footer />
