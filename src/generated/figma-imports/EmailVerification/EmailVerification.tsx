import svgPaths from "./svg-p6jeeblo3b";
import imgImg from "./26831184183db0fa75a765cd0fd0ea9443c6185a.png";
import { imgDecoration } from "./svg-jo2ih";

function Decoration() {
  return (
    <div className="h-[1061.155px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-98.056px_-263.293px] mask-size-[720px_1000px] relative w-[1158.875px]" style={{ maskImage: `url('${imgDecoration}')` }} data-name="decoration">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1158.88 1061.15">
        <g id="decoration">
          ...
          <path d={svgPaths.p2d4d0640} id="circle 1" stroke="url(#paint0_radial_6_31037)" strokeOpacity="0.7" strokeWidth="80" data-figma-bg-blur-radius="10" />
          ...
          <path d={svgPaths.p32982400} id="circle 2" stroke="url(#paint1_radial_6_31037)" strokeOpacity="0.65" strokeWidth="60" data-figma-bg-blur-radius="10" />
          <path d={svgPaths.p2de96700} id="circle 3" stroke="url(#paint2_radial_6_31037)" strokeOpacity="0.81" strokeWidth="80" />
          <ellipse cx="1133.44" cy="75.0571" fill="url(#paint3_linear_6_31037)" id="Ellipse 8" rx="25.4325" ry="25.4711" />
        </g>
        <defs>
          <radialGradient cx="0" cy="0" gradientTransform="matrix(14.8999 706.331 -705.26 14.9225 514.873 553.79)" gradientUnits="userSpaceOnUse" id="paint0_radial_6_31037" r="1">
            <stop offset="0.654764" stopColor="#2E37A4" />
            <stop offset="1" stopColor="#2E37A4" stopOpacity="0.8" />
          </radialGradient>
          <radialGradient cx="0" cy="0" gradientTransform="matrix(12.0647 571.928 -571.061 12.083 517.708 547.241)" gradientUnits="userSpaceOnUse" id="paint1_radial_6_31037" r="1">
            <stop offset="0.654764" stopColor="#E2F6FC" stopOpacity="0.36" />
            <stop offset="1" stopColor="#2E37A4" stopOpacity="0.8" />
          </radialGradient>
          <radialGradient cx="0" cy="0" gradientTransform="matrix(9.65173 457.543 -456.849 9.66639 520.121 543.473)" gradientUnits="userSpaceOnUse" id="paint2_radial_6_31037" r="1">
            <stop offset="0.654764" stopColor="#E2F6FC" stopOpacity="0.36" />
            <stop offset="1" stopColor="#48B7D6" stopOpacity="0" />
          </radialGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_6_31037" x1="1158.88" x2="1107.93" y1="100.528" y2="49.6633">
    ...
    <div className="h-[28px] relative shrink-0 w-[131.384px]" data-name="Logo Container">
      <div className="absolute inset-[-2.47%_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 131.384 29.3837">
          <g id="Logo Container">
            <g id="Icon">
              <path d={svgPaths.p28580780} fill="var(--fill-0, #2E37A4)" id="Rectangle 28" />
              <path d={svgPaths.p2698a500} fill="var(--fill-0, #2E37A4)" id="Rectangle 27" />
              <path d={svgPaths.p4fd6df0} fill="var(--fill-0, #00D3C7)" id="Rectangle 30" />
              <path d={svgPaths.p2f23f940} fill="var(--fill-0, white)" id="Rectangle 30_2" />
            </g>
            <g id="Preclinic">
              <path d={svgPaths.p1a69bd00} fill="var(--fill-0, #030303)" />
              <path d={svgPaths.p187b1080} fill="var(--fill-0, #030303)" />
              <path d={svgPaths.p1a087800} fill="var(--fill-0, #030303)" />
              <path d={svgPaths.p11a672f0} fill="var(--fill-0, #030303)" />
              <path d={svgPaths.p186bcc00} fill="var(--fill-0, #030303)" />
              <path d={svgPaths.p2d8a6100} fill="var(--fill-0, #030303)" />
              <path d={svgPaths.p2df92971} fill="var(--fill-0, #030303)" />
              <path d={svgPaths.p19c52c00} fill="var(--fill-0, #030303)" />
              <path d={svgPaths.p1be5bb80} fill="var(--fill-0, #030303)" />
            </g>
          </g>
        </svg>
      </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 text-center w-full" data-name="Sign In Text Container">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#0a1b39] text-[20px] w-full">
        <p className="leading-[24px]">Email OTP Verification</p>
      </div>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] opacity-70 relative shrink-0 text-[#6c7688] text-[14px] w-full">We sent a code to info@example.com</p>
    </div>
  );
}
      ...
      <div className="bg-[#2e37a4] h-[38px] relative rounded-[6px] shrink-0 w-full" data-name="Button">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] py-[8px] relative size-full">
            <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">{`Verify & Proceed`}</p>
          </div>
        </div>
      </div>
    </div>
...
export default function EmailVerification() {
  return (
    <div className="bg-[#f5f6f8] relative size-full" data-name="Email Verification">
      <ImageContainer />
      <FormSection />
    </div>
  );
