import svgPaths from "./svg-4groacxplh";
import imgAvatarCircle from "./e11f5284f9aaa3e4330ba42e90f83be1f5843642.png";

function Footer() {
  return (
    <div className="absolute bg-white bottom-[4px] content-stretch flex items-center justify-between px-[24px] py-[8px] right-0 w-[1164px]" data-name="Footer">
...
function ExpensesTitleContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[339px]" data-name="Expenses Title Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[24px] not-italic relative shrink-0 text-[#0a1b39] text-[20px] whitespace-nowrap">Expenses Report</p>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 whitespace-nowrap" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#6c7688] text-[14px]">Total Expenses</p>
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[19.2px] relative shrink-0 text-[#0a1b39] text-[16px]">$13,500</p>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="bg-[#ecedf7] content-stretch flex items-center justify-center p-[8px] relative rounded-[4px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#2e37a4] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="flex items-center justify-center relative shrink-0 size-[22.627px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "63" } as React.CSSProperties}>
        <div className="flex-none rotate-45">
          <div className="overflow-clip relative size-[16px]" data-name="Icon">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
              <g id="Vector" />
            </svg>
            <div className="absolute bottom-1/4 left-[29.17%] right-[29.17%] top-1/4" data-name="Vector">
              <div className="absolute inset-[-6.25%_-7.5%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.66667 9">
                  <path d={svgPaths.p251c4d40} id="Vector" stroke="var(--stroke-0, #2E37A4)" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
            <div className="absolute bottom-[12.5%] left-1/2 right-1/2 top-[12.5%]" data-name="Vector">
              <div className="absolute inset-[-4.17%_-0.5px]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 13">
                  <path d="M0.5 0.5V2.5M0.5 10.5V12.5" id="Vector" stroke="var(--stroke-0, #2E37A4)" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
          </div>
...
function Container2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Container">
      <Container3 />
      <div className="flex items-center justify-center relative shrink-0 size-[54.627px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "63" } as React.CSSProperties}>
...
function MeliukLiuk() {
  return (
    <div className="h-[107px] relative w-[197.543px]" data-name="Meliuk-liuk">
      <div className="absolute inset-[0_-0.63%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 200.014 107">
          <g id="Meliuk-liuk">
            <path d={svgPaths.p37608400} id="Path 3 Copy 11" stroke="var(--stroke-0, #D9DBEF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.p2e476500} id="Path 3 Copy 19" stroke="var(--stroke-0, #D9DBEF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.p36cac4c0} id="Path 3 Copy 20" stroke="var(--stroke-0, #D9DBEF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.p12544e00} id="Path 3 Copy 12" stroke="var(--stroke-0, #D9DBEF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.p1f773000} id="Path 3 Copy 13" stroke="var(--stroke-0, #D9DBEF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.pd03d200} id="Path 3 Copy 14" stroke="var(--stroke-0, #D9DBEF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
          </g>
        </svg>
      </div>
    </div>
    ...
    <div className="bg-white flex-[1_0_0] min-w-px relative rounded-[6px]" data-name="Data">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[24px] items-start p-[20px] relative size-full">
          <Container1 />
          <div className="absolute flex items-center justify-center left-[-149.34px] size-[215.344px] top-[-85.66px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "21" } as React.CSSProperties}>
...
function Container10() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 whitespace-nowrap" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#6c7688] text-[14px]">Doctor Payouts</p>
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[19.2px] relative shrink-0 text-[#0a1b39] text-[16px]">$4,500</p>
    </div>
  );
}
...
function Container12() {
  return (
    <div className="bg-[#f4fbf7] content-stretch flex items-center p-[8px] relative rounded-[4px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#27ae60] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="flex items-center justify-center relative shrink-0 size-[22.627px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "126" } as React.CSSProperties}>
        <div className="flex-none rotate-45">
          <div className="overflow-clip relative size-[16px]" data-name="Icon">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
              <g id="Vector" />
            ...
            <div className="absolute inset-[16.67%_41.67%_37.5%_12.5%]" data-name="Vector">
              <div className="absolute inset-[-6.82%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.33333 8.33333">
                  <path d={svgPaths.p1b793d00} id="Vector" stroke="var(--stroke-0, #27AE60)" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
            <div className="absolute bottom-[12.5%] left-[33.33%] right-[16.67%] top-1/2" data-name="Vector">
              <div className="absolute inset-[-8.33%_-6.25%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 7">
                  <path d={svgPaths.p340ac700} id="Vector" stroke="var(--stroke-0, #27AE60)" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
            <div className="absolute inset-[12.5%_54.17%_79.17%_45.83%]" data-name="Vector">
              <div className="absolute inset-[-37.5%_-0.5px]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 2.33333">
                  <path d="M0.5 0.5V1.83333" id="Vector" stroke="var(--stroke-0, #27AE60)" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
            ...
            <div className="absolute bottom-1/2 left-3/4 right-[8.33%] top-[33.33%]" data-name="Vector">
              <div className="absolute inset-[-18.75%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3.66667 3.66667">
                  <path d={svgPaths.pdd25300} id="Vector" stroke="var(--stroke-0, #27AE60)" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
          </div>
...
function Container8() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Container">
      <Container9 />
      <div className="flex items-center justify-center relative shrink-0 size-[54.627px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "126" } as React.CSSProperties}>
        <div className="-rotate-45 flex-none">
          <Container12 />
        </div>
      </div>
...
function MeliukLiuk1() {
  return (
    <div className="h-[107px] relative w-[197.543px]" data-name="Meliuk-liuk">
      <div className="absolute inset-[0_-0.63%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 200.014 107">
          <g id="Meliuk-liuk">
            <path d={svgPaths.p37608400} id="Path 3 Copy 11" stroke="var(--stroke-0, #E9F7EF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.p2e476500} id="Path 3 Copy 19" stroke="var(--stroke-0, #E9F7EF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.p36cac4c0} id="Path 3 Copy 20" stroke="var(--stroke-0, #E9F7EF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.p12544e00} id="Path 3 Copy 12" stroke="var(--stroke-0, #E9F7EF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.p1f773000} id="Path 3 Copy 13" stroke="var(--stroke-0, #E9F7EF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.pd03d200} id="Path 3 Copy 14" stroke="var(--stroke-0, #E9F7EF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
          </g>
        </svg>
      </div>
    </div>
...
function Container16() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 whitespace-nowrap" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#6c7688] text-[14px]">Staff Salaries</p>
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[19.2px] relative shrink-0 text-[#0a1b39] text-[16px]">$3,200</p>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="bg-[#fefbf5] content-stretch flex items-center p-[8px] relative rounded-[4px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e2b93b] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="flex items-center justify-center relative shrink-0 size-[22.627px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "63" } as React.CSSProperties}>
        <div className="flex-none rotate-45">
          <div className="overflow-clip relative size-[16px]" data-name="Icon">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
            ...
            <div className="absolute inset-[12.71%]" data-name="Vector">
              <div className="absolute inset-[-4.19%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.933 12.933">
                  <path d={svgPaths.p3e26ef80} id="Vector" stroke="var(--stroke-0, #E2B93B)" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
            <div className="absolute inset-[35.42%]" data-name="Vector">
              <div className="absolute inset-[-10.71%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.66667 5.66667">
                  <path d="M0.5 0.5L5.16667 5.16667" id="Vector" stroke="var(--stroke-0, #E2B93B)" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
          </div>
...
function MeliukLiuk2() {
  return (
    <div className="h-[107px] relative w-[197.543px]" data-name="Meliuk-liuk">
      <div className="absolute inset-[0_-0.63%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 200.014 107">
          <g id="Meliuk-liuk">
            <path d={svgPaths.p37608400} id="Path 3 Copy 11" stroke="var(--stroke-0, #FCF8EB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.p2e476500} id="Path 3 Copy 19" stroke="var(--stroke-0, #FCF8EB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.p36cac4c0} id="Path 3 Copy 20" stroke="var(--stroke-0, #FCF8EB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.p12544e00} id="Path 3 Copy 12" stroke="var(--stroke-0, #FCF8EB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.p1f773000} id="Path 3 Copy 13" stroke="var(--stroke-0, #FCF8EB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.pd03d200} id="Path 3 Copy 14" stroke="var(--stroke-0, #FCF8EB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
          </g>
        </svg>
      </div>
    </div>
...
function Container22() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 whitespace-nowrap" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#6c7688] text-[14px]">{`Utilities & Rent`}</p>
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[19.2px] relative shrink-0 text-[#0a1b39] text-[16px]">$2,000</p>
    </div>
  );
}
...
function Container24() {
  return (
    <div className="bg-[#fef4f4] content-stretch flex items-center p-[8px] relative rounded-[4px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#ef1e1e] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="flex items-center justify-center relative shrink-0 size-[22.627px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "84" } as React.CSSProperties}>
        <div className="flex-none rotate-45">
          <div className="overflow-clip relative size-[16px]" data-name="Icon">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
              <g id="Vector" />
            ...
            <div className="absolute inset-[12.5%_37.5%_87.5%_37.5%]" data-name="Vector">
              <div className="absolute inset-[-0.5px_-12.5%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 1">
                  <path d="M0.5 0.5H4.5" id="Vector" stroke="var(--stroke-0, #EF1E1E)" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
            <div className="absolute inset-[37.5%_41.67%_62.5%_41.67%]" data-name="Vector">
              <div className="absolute inset-[-0.5px_-18.75%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3.66667 1">
                  <path d="M0.5 0.5H3.16667" id="Vector" stroke="var(--stroke-0, #EF1E1E)" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
            <div className="absolute inset-[12.5%_24.7%]" data-name="Vector">
              <div className="absolute inset-[-4.17%_-6.17%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.09756 13">
                  <path d={svgPaths.p7723500} id="Vector" stroke="var(--stroke-0, #EF1E1E)" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
          </div>
...
function Container20() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Container">
      <Container21 />
      <div className="flex items-center justify-center relative shrink-0 size-[54.627px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "84" } as React.CSSProperties}>
        <div className="-rotate-45 flex-none">
          <Container24 />
        </div>
      </div>
...
function MeliukLiuk3() {
  return (
    <div className="h-[107px] relative w-[197.543px]" data-name="Meliuk-liuk">
      <div className="absolute inset-[0_-0.63%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 200.014 107">
          <g id="Meliuk-liuk">
            <path d={svgPaths.p37608400} id="Path 3 Copy 11" stroke="var(--stroke-0, #FDE9E9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.p2e476500} id="Path 3 Copy 19" stroke="var(--stroke-0, #FDE9E9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.p36cac4c0} id="Path 3 Copy 20" stroke="var(--stroke-0, #FDE9E9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.p12544e00} id="Path 3 Copy 12" stroke="var(--stroke-0, #FDE9E9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.p1f773000} id="Path 3 Copy 13" stroke="var(--stroke-0, #FDE9E9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
            <path d={svgPaths.pd03d200} id="Path 3 Copy 14" stroke="var(--stroke-0, #FDE9E9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.46923" />
          </g>
        </svg>
      </div>
    </div>
...
function Container() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-[1116px]" data-name="Container">
      <Data />
      <Data1 />
      <Data2 />
      <Data3 />
  ...
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Filter Row">
      ...
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with Select">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Category</p>
        <Input1 />
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Tags">
      ...
      <div className="bg-[#f5f6f8] content-stretch flex gap-[4px] h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-bl-[6px] rounded-br-[4px] rounded-tl-[6px] rounded-tr-[4px] shrink-0" data-name="Badge">
        <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-[-0.5px] pointer-events-none rounded-bl-[6.5px] rounded-br-[4.5px] rounded-tl-[6.5px] rounded-tr-[4.5px]" />
        <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[13px] whitespace-nowrap">
          <p className="leading-[19.5px]">Approved</p>
        </div>
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="x">
          <div className="absolute inset-1/4" data-name="Vector">
            <div className="absolute inset-[-8.33%]">
...
function FilterRow1() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Filter Row">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with Select">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Purchased By</p>
        <Input2 />
      </div>
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Expense</p>
          </div>
        </div>
      </div>
    </div>
...
function Container33() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">{`Gloves & Masks`}</p>
    </div>
  );
}
...
function Container32() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Container">
      <Container33 />
    </div>
  );
}
...
function Container37() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Microscope Parts</p>
    </div>
  );
}
...
function Container41() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Thermometers</p>
    </div>
  );
}
...
function Container43() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Disinfectant Supplies</p>
    </div>
  );
}
...
function Container47() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">IV Sets</p>
    </div>
  );
}
...
function Container51() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Reagent Refill</p>
    </div>
  );
}
...
function Container55() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">{`Syringes & Gauze`}</p>
    </div>
  );
}
...
function Container59() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Blood Collection Tubes</p>
    </div>
  );
}
...
function Container63() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">{`Bandages & Tapes`}</p>
    </div>
  );
}
...
function Container67() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Tissue Slides</p>
    </div>
  );
}
...
function Container27() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[190px]" data-name="Container">
      <Container28 />
      <Container29 />
    </div>
  );
...
function Container77() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Medical Supplies</p>
    </div>
  );
}
...
function Container81() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Laboratory</p>
    </div>
  );
}
...
function Container89() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Cleaning Services</p>
    </div>
  );
}
...
function Container88() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[119px]" data-name="Container">
      <Container89 />
    </div>
  );
}
...
function Container157() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[142px]" data-name="Container">
      <Container158 />
      <Container159 />
    </div>
  );
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Container">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Purchased By</p>
          </div>
        </div>
      </div>
    </div>
...
function Container204() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">James Allaire</p>
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="Icon">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
          <g id="Vector" />
        </svg>
...
function Container208() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Esther Schmidt</p>
    </div>
  );
}
...
function Container214() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Judi Lenahan</p>
    </div>
  );
}
...
function Container218() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Robert Reid</p>
    </div>
  );
}
...
function Container222() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Dottie Sellers</p>
    </div>
  );
}
...
function Container228() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Cheryl Bilodeau</p>
    </div>
  );
}
...
function Container248() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Forest Heath</p>
    </div>
  );
}
        ...
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="bg-[#fef4f4] content-stretch flex h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            ...
            <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#ef1e1e] text-[13px] whitespace-nowrap">
              <p className="leading-[19.5px]">Rejected</p>
            </div>
          </div>
        </div>
      </div>
...
function Container256() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Container">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="bg-[#ededfb] content-stretch flex h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            <div aria-hidden="true" className="absolute border border-[#3538cd] border-solid inset-[-0.5px] pointer-events-none rounded-[6.5px]" />
            <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#3538cd] text-[13px] whitespace-nowrap">
              <p className="leading-[19.5px]">New</p>
            </div>
          </div>
        </div>
      </div>
...
function Container262() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[152px]" data-name="Container">
      <Container263 />
      <Container264 />
    </div>
  );
    ...
    <div className="relative shrink-0 size-[32px]" data-name="Number">
      <div className="absolute inset-[-1.56%_-4.69%_-7.81%_-4.69%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 35 35">
          <g filter="url(#filter0_d_6_18273)" id="Number">
          ...
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="35" id="filter0_d_6_18273" width="35" x="0" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_6_18273" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_6_18273" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
...
function ExpenseReportContainer() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[300px] top-[76px] w-[1116px]" data-name="Expense Report Container">
      <HeaderContainer />
      <Container25 />
    </div>
  );
...
export default function ExpenseReport() {
  return (
    <div className="bg-[#f5f6f8] relative size-full" data-name="Expense Report">
      <Footer />
