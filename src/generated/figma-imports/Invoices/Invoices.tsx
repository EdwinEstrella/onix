import svgPaths from "./svg-t35nucthsq";
...
function Footer() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between px-[24px] py-[8px] right-0 top-[971px] w-[1164px]" data-name="Footer">
...
function ExpensesTitleContainer() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-[339px]" data-name="Expenses Title Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[24px] not-italic relative shrink-0 text-[#0a1b39] text-[20px] whitespace-nowrap">Invoices</p>
      <div className="bg-[#ecedf7] content-stretch flex h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
        ...
        <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#2e37a4] text-[13px] whitespace-nowrap">
          <p className="leading-[19.5px]">Total Invoices : 565</p>
        </div>
      </div>
    </div>
  );
...
function HeaderActionsContainer() {
  return (
    <div className="content-stretch flex gap-[12px] items-center justify-end relative shrink-0 w-[614px]" data-name="Header Actions Container">
      ...
      <div className="bg-[#2e37a4] content-stretch flex gap-[4px] items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
        ...
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[19.5px] not-italic relative shrink-0 text-[13px] text-center text-white whitespace-nowrap">New Invoices</p>
      </div>
    </div>
  );
}
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Invoice ID</p>
          </div>
        </div>
      </div>
    </div>
...
function ExpenseItemTextContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#INV0025</p>
    </div>
  );
}
...
function ExpenseItemTextContainer1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#INV0024</p>
    </div>
  );
}
...
function ExpenseItemTextContainer2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#INV0023</p>
    </div>
  );
}
...
function ExpenseItem3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Expense Item">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#INV0022</p>
    </div>
  );
}
...
function ExpenseItemTextContainer3() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#INV0021</p>
    </div>
  );
}
...
function ExpenseItemTextContainer4() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#INV0020</p>
    </div>
  );
}
...
function ExpenseItemTextContainer5() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#INV0019</p>
    </div>
  );
}
...
function ExpenseItemTextContainer6() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#INV0018</p>
    </div>
  );
}
...
function ExpenseItemTextContainer7() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#INV0017</p>
    </div>
  );
}
...
function ExpenseItemTextContainer8() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#INV0016</p>
    </div>
  );
}
...
function ExpenseColumnContainer() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[175px]" data-name="Expense Column Container">
      <ExpenseColumnHeader />
...
function ItemTextContainer() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full" data-name="Item Text Container">
      ...
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="Verified Icon">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
          <g id="Vector" />
        </svg>
      </div>
...
function Item() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Item">
      <ItemTextContainer />
    </div>
  );
}
...
function ItemContainer() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Item Container">
...
function ItemTextContainer1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Item Text Container">
...
function Item3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Item">
      <ItemTextContainer3 />
    </div>
  );
}

function ItemTextContainer2() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Item Text Container">
      <Item3 />
    </div>
  );
}
...
function ColumnContainer1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Column Container">
      <Row />
      <Row1 />
      <Row2 />
      <Row3 />
...
function ColumnContainer() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[232px]" data-name="Column Container">
      <ColumnHeader />
      <ColumnContainer1 />
    </div>
  );
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Date Column Header">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Created Date</p>
          </div>
        </div>
      </div>
    </div>
...
function DateColumnContainer() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[168px]" data-name="Date Column Container">
      <DateColumnHeader />
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Column Header">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Due Date</p>
          </div>
        </div>
      </div>
    </div>
...
function ItemContainer10() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Item Container">
      <Item14 />
    </div>
  );
}
...
function ColumnContainer3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px relative w-full" data-name="Column Container">
      <Row10 />
      <Row11 />
      <Row12 />
      <Row13 />
...
function ColumnContainer2() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[168px]" data-name="Column Container">
      <ColumnHeader1 />
      <ColumnContainer3 />
    </div>
  );
...
function AmountColumnHeader() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Amount Column Header">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
...
function AmountItem() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Amount Item">
...
function AmountItemContainer() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Amount Item Container">
      <AmountItem />
    </div>
  );
}
...
function AmountRow() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Amount Row">
      <AmountItemContainer />
    </div>
  );
}

function AmountRowsContainer() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Amount Rows Container">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <AmountRow />
...
function AmountItemText() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Amount Item Text">
...
function AmountItem1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Amount Item">
      <AmountItemText />
    </div>
  );
}

function AmountItemContainer1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Amount Item Container">
      <AmountItem1 />
    </div>
  );
}
...
function AmountRow1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Amount Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <AmountItemContainer1 />
        </div>
      </div>
    </div>
  );
...
function AmountColumnContainer1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px relative w-full" data-name="Amount Column Container">
      <AmountRowsContainer />
      <AmountRow1 />
      <AmountRow2 />
      <AmountRow3 />
...
function AmountColumnContainer() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[121px]" data-name="Amount Column Container">
      <AmountColumnHeader />
      <AmountColumnContainer1 />
    </div>
  );
}
        ...
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="bg-[#f4fbf7] content-stretch flex h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            ...
            <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#27ae60] text-[13px] whitespace-nowrap">
              <p className="leading-[19.5px]">Paid</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="bg-[#fefbf5] content-stretch flex h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            ...
            <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#e2b93b] text-[13px] whitespace-nowrap">
              <p className="leading-[19.5px]">Partially Paid</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="bg-[#fef4f4] content-stretch flex h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            ...
            <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#ef1e1e] text-[13px] whitespace-nowrap">
              <p className="leading-[19.5px]">Unpaid</p>
            </div>
          </div>
        </div>
      </div>
...
function StatusColumnContainer() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[123px]" data-name="Status Column Container">
      <StatusColumnHeader />
...
function ActionsColumnHeader() {
  return (
    <div className="bg-white h-[45px] relative shrink-0 w-full" data-name="Actions Column Header">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
...
function ActionsItem() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Actions Item">
...
function ActionsRow() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Actions Row">
      <ActionsItem />
    </div>
  );
}

function ActionsRowsContainer() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Actions Rows Container">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
...
function ActionsRow1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Actions Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center px-[16px] py-[8px] relative size-full">
          <ActionsItem1 />
...
function ActionsColumnContainer1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px relative w-full" data-name="Actions Column Container">
      <ActionsRowsContainer />
      <ActionsRow1 />
      <ActionsRow2 />
      <ActionsRow3 />
      <ActionsRow4 />
...
function ActionsColumnContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-start min-w-px relative" data-name="Actions Column Container">
      <ActionsColumnHeader />
      <ActionsColumnContainer1 />
    </div>
  );
}
...
function InvoiceContainer() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[300px] top-[76px] w-[1116px]" data-name="Invoice Container">
      <HeaderContainer />
      <TableContainer />
    ...
    <div className="relative shrink-0 size-[25.351px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 25.3507 25.3507">
        <g id="Icon">
          ...
          <path d={svgPaths.p2201b300} fill="var(--fill-0, #2E37A4)" id="Rectangle 27" />
...
function SidebarScroll() {
  return (
    <div className="absolute content-stretch flex h-[1086px] items-start left-0 top-0" data-name="Sidebar  Scroll">
...
export default function Invoices() {
  return (
    <div className="bg-[#f5f6f8] relative size-full" data-name="Invoices">
      <Footer />
      <InvoiceContainer />
