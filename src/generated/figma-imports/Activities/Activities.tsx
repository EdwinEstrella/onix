import svgPaths from "./svg-briadp894p";
import imgImage from "./dd14890569b1b55884719ed01c3d03d44cb18a21.png";
import imgImage1 from "./4f2f469649a16f6afbe607fb04c5374185f0325a.png";
import imgImage2 from "./d2db9bbb04f17d5c616dbff2714fc254df098254.png";
import imgImage3 from "./86ec64caf94444c99efa198311fa4f444ff553e0.png";
import imgAvatarCircle from "./e11f5284f9aaa3e4330ba42e90f83be1f5843642.png";

function Footer() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between px-[24px] py-[8px] right-0 top-[861px] w-[1164px]" data-name="Footer">
...
function HeaderLeftContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[339px]" data-name="Header Left Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[24px] not-italic relative shrink-0 text-[#0a1b39] text-[20px] whitespace-nowrap">Activities</p>
    </div>
  );
}
...
function HeaderContainer2() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full" data-name="Header Container">
      <HeaderContainer3 />
    </div>
  );
}
...
function DateContainer() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Date Container">
      <p className="font-['Archivo:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[14px] text-black whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        24 Sep 2024
      </p>
    </div>
  );
...
function StatusIndicatorContainer() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Status Indicator Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Status Indicator Container">
          <rect fill="var(--fill-0, white)" height="23" rx="11.5" width="23" x="0.5" y="0.5" />
          <rect height="23" rx="11.5" stroke="var(--stroke-0, #E5E7EB)" width="23" x="0.5" y="0.5" />
          <circle cx="12" cy="12" fill="var(--fill-0, #E8E9EA)" id="Ellipse 611" r="3.5" stroke="var(--stroke-0, #E5E7EB)" />
        </g>
      </svg>
    </div>
  );
...
function ActivityDetails() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 text-[14px] w-[873.357px]" data-name="Activity Details">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#111827] whitespace-nowrap">Completed the Patient visit at Glory Hospital in Florida, USA .</p>
      <p className="font-['Archivo:Regular',sans-serif] font-normal leading-[24px] min-w-full relative shrink-0 text-[#6b7280] w-[min-content]" style={{ fontVariationSettings: "'wdth' 100" }}>
        The patient successfully completed a scheduled visit. All clinical notes, diagnostics, and visit outcomes have been recorded and stored in the medical record.
      </p>
    </div>
  );
}
...
function ActivityItem() {
  return (
    <div className="content-stretch flex gap-[40px] items-center relative shrink-0" data-name="Activity Item">
      <DateContainer />
...
function StatusIndicatorContainer1() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Status Indicator Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Status Indicator Container">
...
function ActivityDetails4() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 whitespace-nowrap" data-name="Activity Details">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] relative shrink-0 text-[#111827] text-[14px]">Bernardo James Uploaded 4 new photos for World Safety Event</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#6b7280] text-[13px]">02:30 AM, April 9 - 2025, Bernardo James, Uploaded 4 new photos</p>
    </div>
  );
}
...
function ImageGallery() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0" data-name="Image Gallery">
      <div className="relative rounded-[10px] shrink-0 size-[96px]" data-name="image">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[10px]">
          <img alt="" className="absolute h-full left-[-45%] max-w-none top-0 w-[150%]" src={imgImage} />
        </div>
      </div>
      <div className="relative rounded-[10px] shrink-0 size-[96px]" data-name="image">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[10px]">
          <img alt="" className="absolute h-full left-[-2%] max-w-none top-0 w-[150%]" src={imgImage1} />
        </div>
      </div>
      <div className="relative rounded-[10px] shrink-0 size-[96px]" data-name="image">
...
function ActivityDetails3() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0" data-name="Activity Details">
      <ActivityDetails4 />
      <ImageGallery />
    </div>
  );
...
function ActivityDetails2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Activity Details">
      <ActivityDetails3 />
    </div>
  );
}
...
function ActivityDetails1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[893.357px]" data-name="Activity Details">
      <ActivityDetails2 />
    </div>
  );
}
...
function ActivityItem1() {
  return (
    <div className="content-stretch flex gap-[40px] items-center relative shrink-0 w-full" data-name="Activity Item">
      <DateContainer1 />
      <StatusIndicatorContainer1 />
      <ActivityDetails1 />
    </div>
  );
}
...
function StatusIndicatorContainer2() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Status Indicator Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Status Indicator Container">
...
function ActivityDetails5() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 text-[14px] w-[873.357px]" data-name="Activity Details">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] min-w-full not-italic relative shrink-0 text-[#111827] w-[min-content]">Dr. Linda Carpenter Doctors Meeting</p>
      <p className="font-['Archivo:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#6b7280] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function StatusIndicatorContainer3() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Status Indicator Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Status Indicator Container">
...
function ActivityDetails6() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 text-[14px] w-[873.357px]" data-name="Activity Details">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#111827] w-full">Dr.Markhay smith was Completed the Operation With in Deadline</p>
      <p className="font-['Archivo:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#6b7280] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>{` The operation was successfully completed within the scheduled deadline.`}</p>
    </div>
  );
}
...
function StatusIndicatorContainer4() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Status Indicator Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Status Indicator Container">
...
function ImageContainer() {
  return (
    <div className="content-stretch flex items-center p-[10px] relative shrink-0" data-name="Image Container">
      <div className="relative rounded-[10px] shrink-0 size-[172px]" data-name="image">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[10px] size-full" src={imgImage3} />
      </div>
    </div>
  );
...
function TagContainer() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[74px]" data-name="Tag Container">
      <div className="bg-[#2f80ed] h-[20px] relative rounded-[6px] shrink-0 w-full" data-name="Badge">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[8px] py-[2px] relative size-full">
            <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-white whitespace-nowrap">
              <p className="leading-[18px]">Safety</p>
            </div>
          </div>
        </div>
      </div>
...
function DateContainer5() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Date Container">
      <p className="font-['Archivo:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#6b7280] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        March 10, 2025
      </p>
    </div>
  );
...
function ContentHeader() {
  return (
    <div className="content-stretch flex gap-[14px] items-end relative shrink-0" data-name="Content Header">
      <TagContainer />
      <DateContainer5 />
    </div>
  );
...
function ContentTitle() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Content Title">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">{`Rio Williams posted a new blog `}</p>
    </div>
  );
}
...
function ContentDescription() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Content Description">
      <p className="flex-[1_0_0] font-['Archivo:Regular',sans-serif] font-normal leading-[24px] min-w-px relative text-[#6b7280] text-[14px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        “Stay informed on how to keep your clinic environment safe. Rio shares essential COVID-19 safety protocols, from sanitization tips to patient screening procedures.”
      </p>
    </div>
  );
}
...
function ReadMoreButton() {
  return (
    <div className="content-stretch flex flex-col items-start p-[10px] relative shrink-0 w-[125px]" data-name="Read More Button">
      <div className="bg-[#2e37a4] relative rounded-[6px] shrink-0 w-full" data-name="Button">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[4px] items-center justify-center px-[10px] py-[6px] relative size-full">
            <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[19.5px] not-italic relative shrink-0 text-[13px] text-center text-white whitespace-nowrap">Read more</p>
            <div className="overflow-clip relative shrink-0 size-[13px]" data-name="chevron-right">
              <div className="absolute bottom-1/4 left-[37.5%] right-[37.5%] top-1/4" data-name="Vector">
                <div className="absolute inset-[-15.38%_-30.77%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.25 8.5">
                    <path d="M1 1L4.25 4.25L1 7.5" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                  </svg>
                </div>
              </div>
            </div>
...
function ContentDetails() {
  return (
    <div className="flex-[1_0_0] min-w-px relative" data-name="Content Details">
...
function ActivityContent() {
  return (
    <div className="bg-[#f5f6f8] content-stretch flex gap-[10px] items-center relative rounded-[10px] shrink-0 w-full" data-name="Activity Content">
      <ImageContainer />
      <ContentDetails />
    </div>
  );
...
function ActivityDetails7() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[873.357px]" data-name="Activity Details">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#111827] text-[14px] w-full">{` Rio Williams Posted a Blog about Corona Safety Measurements`}</p>
      <ActivityContent />
    </div>
  );
}
...
function ActivityList() {
  return (
    <div className="bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex flex-col gap-[24px] items-start p-[20px] relative rounded-[6px] shrink-0 w-[1076.357px]" data-name="Activity List">
      ...
      <ActivityItem3 />
      <ActivityItem4 />
      <div className="absolute flex h-[502px] items-center justify-center left-[150px] top-[61px] w-0" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "21" } as React.CSSProperties}>
        <div className="flex-none rotate-90">
          <div className="h-0 relative w-[502px]">
            <div className="absolute inset-[-1px_0_0_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 502 1">
                <line id="Line 187" stroke="var(--stroke-0, #E5E7EB)" strokeDasharray="6 6" x2="502" y1="0.5" y2="0.5" />
              </svg>
            </div>
          </div>
        </div>
              ...
              <div className="absolute inset-[16.67%_12.5%]" data-name="Vector">
                <div className="absolute inset-[-5.36%_-4.76%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.5 10.3333">
                    <path d={svgPaths.p5c12300} id="Vector" stroke="var(--stroke-0, #2E37A4)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
            </div>
...
function SidebarScroll() {
  return (
    <div className="absolute content-stretch flex items-start left-0 top-0" data-name="Sidebar  Scroll">
...
export default function Activities() {
  return (
    <div className="bg-[#f5f6f8] relative size-full" data-name="Activities">
      <Footer />
      <MainContainer />
