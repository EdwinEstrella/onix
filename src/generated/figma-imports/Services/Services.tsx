import svgPaths from "./svg-r8nh9g33d2";
...
function TitleContainer() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-[339px]" data-name="Title Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[24px] not-italic relative shrink-0 text-[#0a1b39] text-[20px] whitespace-nowrap">Services</p>
      <div className="bg-[#ecedf7] content-stretch flex h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
        ...
        <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#2e37a4] text-[13px] whitespace-nowrap">
          <p className="leading-[19.5px]">Total Services : 565</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex gap-[12px] items-center justify-end relative shrink-0 w-[614px]" data-name="Header Actions">
      ...
      <div className="bg-[#2e37a4] content-stretch flex gap-[4px] items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
        ...
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[19.5px] not-italic relative shrink-0 text-[13px] text-center text-white whitespace-nowrap">New Services</p>
      </div>
    </div>
  );
}
...
function Filters() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0" data-name="Filters">
...
function SearchAndFilters1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative" data-name="Search and Filters">
...
function SearchAndFilters() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Search and Filters">
      <SearchAndFilters1 />
    </div>
  );
}
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Service Name</p>
          </div>
        </div>
      </div>
    </div>
...
function TableBody() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px relative w-full" data-name="Table Body">
      <TableRow />
      <TableRow1 />
      <TableRow2 />
      <TableRow3 />
...
function TableHeader() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[270px]" data-name="Table Header">
      <TableHeaderCell />
      <TableBody />
    </div>
  );
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Table Header Cell">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Department</p>
          </div>
        </div>
      </div>
    </div>
...
function TableCell30() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Table Cell">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">General Medicine</p>
    </div>
  );
}
...
function TableCell28() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-h-px relative w-full" data-name="Table Cell">
      <TableCell29 />
    </div>
  );
}
...
function TableCell33() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[111px]" data-name="Table Cell">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Dentistry</p>
    </div>
  );
}
...
function TableCell36() {
  return (
    <div className="content-stretch flex h-[21px] items-center relative shrink-0 w-full" data-name="Table Cell">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal h-full leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Ophthalmology</p>
    </div>
  );
}
...
function TableCell39() {
  return (
    <div className="content-stretch flex h-[21px] items-center relative shrink-0 w-full" data-name="Table Cell">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal h-full leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Radiology</p>
    </div>
  );
}
...
function TableCell40() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-h-px relative w-full" data-name="Table Cell">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">Physiotherapy</p>
    </div>
  );
}
...
function TableCell43() {
  return (
    <div className="content-stretch flex h-[21px] items-center relative shrink-0 w-full" data-name="Table Cell">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal h-full leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Cardiology</p>
    </div>
  );
}
...
function TableCell46() {
  return (
    <div className="content-stretch flex h-[21px] items-center relative shrink-0 w-full" data-name="Table Cell">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal h-full leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Dermatology</p>
    </div>
  );
}
...
function TableCell45() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Table Cell">
      <TableCell46 />
    </div>
  );
}
...
function TableCell49() {
  return (
    <div className="content-stretch flex h-[21px] items-center relative shrink-0 w-full" data-name="Table Cell">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal h-full leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Pathology</p>
    </div>
  );
}
...
function TableCell52() {
  return (
    <div className="content-stretch flex h-[21px] items-center relative shrink-0 w-[100px]" data-name="Table Cell">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal h-full leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">ENT</p>
    </div>
  );
}
...
function TableCell55() {
  return (
    <div className="content-stretch flex h-[21px] items-center relative shrink-0 w-full" data-name="Table Cell">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal h-full leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Nutrition</p>
    </div>
  );
}
...
function TableCell54() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[130px]" data-name="Table Cell">
      <TableCell55 />
    </div>
  );
}
...
function TableHeader1() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[288px]" data-name="Table Header">
      <TableHeaderCell1 />
      <TableBody1 />
    </div>
  );
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Table Header Cell">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Price</p>
          </div>
        </div>
      </div>
    </div>
...
function TableCell65() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[107px]" data-name="Table Cell">
      <TableCell66 />
    </div>
  );
}
        ...
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="bg-[#f4fbf7] content-stretch flex h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            ...
            <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#27ae60] text-[13px] whitespace-nowrap">
              <p className="leading-[19.5px]">Active</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="bg-[#fef4f4] content-stretch flex h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            ...
            <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#ef1e1e] text-[13px] whitespace-nowrap">
              <p className="leading-[19.5px]">Inactive</p>
            </div>
          </div>
        </div>
      </div>
...
function TableHeaderCell4() {
  return (
    <div className="bg-white h-[45px] relative shrink-0 w-full" data-name="Table Header Cell">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
...
function TableHeader4() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[126px]" data-name="Table Header">
      <TableHeaderCell4 />
      <TableRow40 />
      <TableRow41 />
      <TableRow42 />
...
function Table() {
  return (
    <div className="content-stretch flex h-[525px] items-center relative shrink-0 w-[1116.333px]" data-name="Table">
...
function MainContainer() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[300px] top-[75.59px] w-[1116px]" data-name="Main Container">
      <Header />
      <Table />
              ...
              <div className="absolute bottom-[12.5%] left-1/4 right-[47.92%] top-[62.5%]" data-name="Vector">
                <div className="absolute inset-[-14.29%_-13.19%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4.79167 4.5">
                    <path d={svgPaths.p27feb980} id="Vector" stroke="var(--stroke-0, #2E37A4)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
...
function SidebarScroll() {
  return (
    <div className="absolute content-stretch flex h-[926px] items-start left-0 top-0" data-name="Sidebar  Scroll">
...
export default function Services() {
  return (
    <div className="bg-[#f5f6f8] relative size-full" data-name="Services">
      <Footer />
      <MainContainer />
      <div className="absolute bg-white content-stretch flex flex-col h-[52px] items-start justify-center left-[276px] px-[24px] py-[8px] top-[-0.41px] w-[1164px]" data-name="Header">
        <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
        <Container />
      </div>
      <SidebarScroll />
