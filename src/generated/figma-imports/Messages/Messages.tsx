import svgPaths from "./svg-s3iudz713v";
import imgAvatarTypes from "./be7bbbdec5dcf6b4b783c3c1e389c02b7cd64ebe.png";
import imgAvatarTypes1 from "./708c00faae3b5962dfe27443b559ef9b197bfc24.png";
import imgAvatarTypes2 from "./6669ab8f1227c9889e0f78c53983f067fd8dbcbe.png";
import imgAvatarTypes3 from "./026992a3cc33efdd88e9ec6cbc4a607475dce6bf.png";
import imgAvatarTypes4 from "./c995a9012d2c90781caba0c947710c02c955b582.png";
import imgAvatarTypes5 from "./7f7f2cb3227f3983162739fa262cb24cda83e720.png";
import imgAvatarTypes6 from "./aabd9ba615fb0b25a1fa8cb21bd65eccf56ae864.png";
import imgAvatarTypes7 from "./1e00ce78d4716ed5a8bc93dc2264d703e75aa3db.png";
import imgAvatarTypes8 from "./e91e1c3cf8bd54e1d07464de852c10b511a11233.png";
import imgAvatarTypes9 from "./2df91df0994241523d03ab731516f8ac9a6e00a6.png";
import imgAvatarCircle from "./ba013c61bff5e7ac2818d755ede0bf6a74b2faf7.png";
import imgAvatarCircle1 from "./be7bbbdec5dcf6b4b783c3c1e389c02b7cd64ebe.png";
import imgAvatarCircle2 from "./667a145953150374b834712e00e6b344702c0866.png";
import imgAvatarCircle3 from "./e11f5284f9aaa3e4330ba42e90f83be1f5843642.png";

function Footer() {
  return (
    <div className="absolute bg-white bottom-[-0.41px] content-stretch flex items-center justify-between px-[24px] py-[8px] right-0 w-[1164px]" data-name="Footer">
...
function HeaderLeft() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[339px]" data-name="Header Left">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[24px] not-italic relative shrink-0 text-[#0a1b39] text-[20px] whitespace-nowrap">Chat</p>
    </div>
  );
}

function HeaderRight() {
  return <div className="h-[32px] shrink-0 w-[614px]" data-name="Header Right" />;
}
...
function ChatItemHeader2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="Chat Item Header">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[21.6px] not-italic relative shrink-0 text-[#0a1b39] text-[18px] whitespace-nowrap">Chat</p>
    </div>
  );
}
...
function ChatItemActions() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Chat Item Actions">
        ...
        <div className="absolute inset-[12.5%_29.17%_29.17%_12.5%]" data-name="Vector">
          <div className="absolute inset-[-5.36%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.3333 10.3333">
              <path d={svgPaths.pb4b1600} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[62.5%_12.5%_12.5%_62.5%]" data-name="Vector">
          <div className="absolute inset-[-12.5%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 5">
              <path d="M4.5 4.5L0.5 0.5" id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      </div>
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="More Options Icon">
        ...
        <div className="absolute inset-[45.83%]" data-name="Vector">
          <div className="absolute inset-[-75%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3.33333 3.33333">
              <path d={svgPaths.p2ecb0100} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
...
function ChatItemHeader1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-w-px relative" data-name="Chat Item Header">
      <ChatItemHeader2 />
      <ChatItemActions />
    </div>
  );
...
function ChatItemHeader() {
  return (
    <div className="h-[72px] relative rounded-tr-[10px] shrink-0 w-full" data-name="Chat Item Header">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none rounded-tr-[10px]" />
...
function TimeContainer() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Time Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#6c7688] text-[12px] text-center whitespace-nowrap">Just Now</p>
    </div>
  );
}

function ChatItemHeader3() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Header">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Mark Villiams</p>
      <TimeContainer />
    </div>
  );
}

function ChatItemMessage() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Message">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[18px] min-w-px not-italic relative text-[#6c7688] text-[12px]">Have you called them?</p>
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="Status Icon">
        <div className="absolute inset-[29.17%_8.33%_29.17%_29.17%]" data-name="Vector">
          <div className="absolute inset-[-8.57%_-5.71%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.75 6.83333">
              <path d={svgPaths.p287e0700} id="Vector" stroke="var(--stroke-0, #27AE60)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[29.17%_29.17%_29.17%_8.33%]" data-name="Vector">
          <div className="absolute inset-[-8.57%_-5.71%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.75 6.83333">
              <path d={svgPaths.p1c24ed80} id="Vector" stroke="var(--stroke-0, #27AE60)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      </div>
...
function MediaBody() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Media Body">
      <ChatItemHeader3 />
      <ChatItemMessage />
    </div>
  );
...
function Media() {
  return (
    <div className="bg-[#f5f6f8] relative rounded-[10px] shrink-0 w-full" data-name="Media">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[12px] relative size-full">
          <div className="relative shrink-0 size-[40px]" data-name="Avatar Types">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="40" src={imgAvatarTypes} width="40" />
            <div className="absolute inset-[77.5%_7.5%_10%_80%]">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 5">
                <circle cx="2.5" cy="2.5" fill="var(--fill-0, #27AE60)" id="Ellipse 624" r="2.25" stroke="var(--stroke-0, white)" strokeWidth="0.5" />
              </svg>
            </div>
          </div>
          <MediaBody />
...
function ChatItemHeader4() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Header">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Andrew Simmons</p>
      <TimeContainer1 />
    </div>
  );
}
...
function Counts() {
  return (
    <div className="bg-[#2f80ed] content-stretch flex flex-col items-center justify-center p-[6px] relative rounded-[40px] shrink-0 size-[14px]" data-name="Counts">
      <div className="flex flex-col font-['Instrument_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[12px] text-center text-white w-[6px]" style={{ fontVariationSettings: "'wdth' 100" }}>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Media">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[12px] relative size-full">
          <div className="relative shrink-0 size-[40px]" data-name="Avatar Types">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="40" src={imgAvatarTypes1} width="40" />
            <div className="absolute inset-[77.5%_7.5%_10%_80%]">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 5">
                <circle cx="2.5" cy="2.5" fill="var(--fill-0, #27AE60)" id="Ellipse 624" r="2.25" stroke="var(--stroke-0, white)" strokeWidth="0.5" />
              </svg>
...
function TimeContainer2() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Time Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#6c7688] text-[12px] text-center whitespace-nowrap">11.49 AM</p>
    </div>
  );
}

function ChatItemHeader5() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Header">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">David Steiger</p>
      <TimeContainer2 />
    </div>
  );
}

function ChatItemMessage2() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Message">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[18px] min-w-px not-italic relative text-[#27ae60] text-[12px]">Typing...</p>
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="Status Icon">
        <div className="absolute inset-[29.17%_8.33%_29.17%_29.17%]" data-name="Vector">
          <div className="absolute inset-[-8.57%_-5.71%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.75 6.83333">
              <path d={svgPaths.p287e0700} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[29.17%_29.17%_29.17%_8.33%]" data-name="Vector">
          <div className="absolute inset-[-8.57%_-5.71%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.75 6.83333">
              <path d={svgPaths.p1c24ed80} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Media">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[12px] relative size-full">
          <div className="relative shrink-0 size-[40px]" data-name="Avatar Types">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="40" src={imgAvatarTypes2} width="40" />
            <div className="absolute inset-[77.5%_7.5%_10%_80%]">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 5">
                <circle cx="2.5" cy="2.5" fill="var(--fill-0, #27AE60)" id="Ellipse 624" r="2.25" stroke="var(--stroke-0, white)" strokeWidth="0.5" />
              </svg>
...
function TimeContainer3() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Time Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#6c7688] text-[12px] text-center whitespace-nowrap">10 mins ago</p>
    </div>
  );
}

function ChatItemHeader6() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Header">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Leena Luch</p>
      <TimeContainer3 />
    </div>
  );
}
...
function Message() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="Message">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[18px] min-w-px not-italic relative text-[#6c7688] text-[12px]">Video</p>
    </div>
  );
}

function ChatItemMessage3() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Message">
      <Message />
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="Status Icon">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Media">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[12px] relative size-full">
          <div className="relative shrink-0 size-[40px]" data-name="Avatar Types">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="40" src={imgAvatarTypes3} width="40" />
            <div className="absolute inset-[77.5%_7.5%_10%_80%]">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 5">
                <circle cx="2.5" cy="2.5" fill="var(--fill-0, #E7E8EB)" id="Ellipse 625" r="2.5" />
              </svg>
            </div>
          </div>
          <MediaBody3 />
...
function TimeContainer4() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Time Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#6c7688] text-[12px] text-center whitespace-nowrap">Yesterday</p>
    </div>
  );
}

function ChatItemHeader7() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Header">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Walter Hartmann</p>
      <TimeContainer4 />
    </div>
  );
}

function ChatItemMessage4() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Message">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[18px] min-w-px not-italic relative text-[#6c7688] text-[12px]">Do you knoe which...</p>
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="Status Icon">
        <div className="absolute inset-[29.17%_16.67%_29.17%_20.83%]" data-name="Vector">
          <div className="absolute inset-[-8.57%_-5.71%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.75 6.83333">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Media">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[12px] relative size-full">
          <div className="relative shrink-0 size-[40px]" data-name="Avatar Types">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="40" src={imgAvatarTypes4} width="40" />
            <div className="absolute inset-[77.5%_7.5%_10%_80%]">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 5">
                <circle cx="2.5" cy="2.5" fill="var(--fill-0, #27AE60)" id="Ellipse 624" r="2.25" stroke="var(--stroke-0, white)" strokeWidth="0.5" />
              </svg>
...
function TimeContainer5() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Time Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#6c7688] text-[12px] text-center whitespace-nowrap">Wednesday</p>
    </div>
  );
}

function ChatItemHeader8() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Header">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Andrea Jermaine</p>
      <TimeContainer5 />
    </div>
  );
}
...
function Message1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-w-px relative" data-name="Message">
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="Audio Icon">
        <div className="absolute inset-[8.33%_37.5%_45.83%_37.5%]" data-name="Vector">
          <div className="absolute inset-[-7.79%_-14.29%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4.5 7.41667">
              <path d={svgPaths.p38cd9290} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[41.67%_20.83%_29.17%_20.83%]" data-name="Vector">
          <div className="absolute inset-[-12.24%_-6.12%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.16667 5.08333">
              <path d={svgPaths.p2dc7b480} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[87.5%_33.33%_12.5%_33.33%]" data-name="Vector">
          <div className="absolute inset-[-0.5px_-10.71%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.66667 1">
              <path d="M0.5 0.5H5.16667" id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      ...
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[18px] min-w-px not-italic relative text-[#6c7688] text-[12px]">Audio</p>
    </div>
  );
}

function ChatItemMessage5() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Message">
      <Message1 />
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="Status Icon">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Media">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[12px] relative size-full">
          <div className="relative shrink-0 size-[40px]" data-name="Avatar Types">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="40" src={imgAvatarTypes5} width="40" />
            <div className="absolute inset-[77.5%_7.5%_10%_80%]">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 5">
                <circle cx="2.5" cy="2.5" fill="var(--fill-0, #27AE60)" id="Ellipse 624" r="2.25" stroke="var(--stroke-0, white)" strokeWidth="0.5" />
              </svg>
...
function TimeContainer6() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Time Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#6c7688] text-[12px] text-center whitespace-nowrap">1 week ago</p>
    </div>
  );
}

function ChatItemHeader9() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Header">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Lan Adams</p>
      <TimeContainer6 />
    </div>
  );
}
...
function ChatItemMessage6() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Message">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[18px] min-w-px not-italic relative text-[#6c7688] text-[12px]">Thank You</p>
      <Counts1 />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Media">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[12px] relative size-full">
          <div className="relative shrink-0 size-[40px]" data-name="Avatar Types">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="40" src={imgAvatarTypes6} width="40" />
            <div className="absolute inset-[77.5%_7.5%_10%_80%]">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 5">
                <circle cx="2.5" cy="2.5" fill="var(--fill-0, #E7E8EB)" id="Ellipse 625" r="2.5" />
              </svg>
...
function ChatItemHeader10() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Header">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Ann Crump</p>
      <TimeContainer7 />
    </div>
  );
}
...
function Message2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-w-px relative" data-name="Message">
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="Photo Icon">
        <div className="absolute inset-[33.33%_37.46%_66.67%_62.5%]" data-name="Vector">
          <div className="absolute inset-[-0.5px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.00583 1">
              <path d="M0.5 0.5H0.505833" id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[12.5%]" data-name="Vector">
          <div className="absolute inset-[-4.76%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.5 11.5">
              <path d={svgPaths.p3d0ba780} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[43.04%_33.33%_33.33%_12.5%]" data-name="Vector">
          <div className="absolute inset-[-15.12%_-6.59%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.58333 4.30735">
              <path d={svgPaths.p2a3e7380} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[51.38%_12.5%_33.33%_58.33%]" data-name="Vector">
          <div className="absolute inset-[-23.36%_-12.24%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.08333 3.14069">
              <path d={svgPaths.p3e313f00} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      </div>
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[18px] min-w-px not-italic relative text-[#6c7688] text-[12px]">Photo</p>
    </div>
  );
}

function ChatItemMessage7() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Message">
      <Message2 />
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="Status Icon">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Media">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[12px] relative size-full">
          <div className="relative shrink-0 size-[40px]" data-name="Avatar Types">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="40" src={imgAvatarTypes7} width="40" />
            <div className="absolute inset-[77.5%_7.5%_10%_80%]">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 5">
                <circle cx="2.5" cy="2.5" fill="var(--fill-0, #27AE60)" id="Ellipse 624" r="2.25" stroke="var(--stroke-0, white)" strokeWidth="0.5" />
              </svg>
...
function TimeContainer8() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Time Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#6c7688] text-[12px] text-center whitespace-nowrap">Friday</p>
    </div>
  );
}

function ChatItemHeader11() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Header">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Julie Black</p>
      <TimeContainer8 />
    </div>
  );
}

function ChatItemMessage8() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Message">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[18px] min-w-px not-italic relative text-[#6c7688] text-[12px]">Thank You</p>
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="Status Icon">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Media">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[12px] relative size-full">
          <div className="relative shrink-0 size-[40px]" data-name="Avatar Types">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="40" src={imgAvatarTypes8} width="40" />
            <div className="absolute inset-[77.5%_7.5%_10%_80%]">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 5">
                <circle cx="2.5" cy="2.5" fill="var(--fill-0, #E7E8EB)" id="Ellipse 625" r="2.5" />
              </svg>
...
function ChatItemHeader12() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Header">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Jean Walker</p>
      <TimeContainer9 />
    </div>
  );
}

function ChatItemMessage9() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Chat Item Message">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[18px] min-w-px not-italic relative text-[#6c7688] text-[12px]">Excellent work!</p>
      <div className="bg-[#2f80ed] content-stretch flex flex-col items-center justify-center p-[6px] relative rounded-[40px] shrink-0 size-[14px]" data-name="Counts">
        <div className="flex flex-col font-['Albert_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[12px] text-center text-white w-[6px]">
          <p className="leading-[18px]">2</p>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Media">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[12px] relative size-full">
          <div className="relative shrink-0 size-[40px]" data-name="Avatar Types">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="40" src={imgAvatarTypes9} width="40" />
            <div className="absolute inset-[77.5%_7.5%_10%_80%]">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 5">
                <circle cx="2.5" cy="2.5" fill="var(--fill-0, #27AE60)" id="Ellipse 624" r="2.25" stroke="var(--stroke-0, white)" strokeWidth="0.5" />
              </svg>
...
function ChatItemContainer() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Chat Item Container">
      <Media />
      <Media1 />
      <Media2 />
      <Media3 />
...
function ChatItem1() {
  return (
    <div className="relative shrink-0 w-full" data-name="Chat Item">
...
function ChatItem() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[775px] items-start relative rounded-[6px] shrink-0 w-[363px]" data-name="Chat Item">
...
function MediaBody10() {
  return (
    <div className="content-stretch flex flex-col items-start not-italic relative shrink-0 text-center whitespace-nowrap" data-name="Media Body">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] relative shrink-0 text-[#0a1b39] text-[16px]">Mark Villiams</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#6c7688] text-[14px]">Last Seen at 07:15 PM</p>
    </div>
  );
}
...
function Media10() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative" data-name="Media">
      <div className="relative shrink-0 size-[48px]" data-name="Avatar Circle">
        <img alt="" className="absolute block inset-0 max-w-none size-full" height="48" src={imgAvatarCircle} width="48" />
      </div>
      <MediaBody10 />
    </div>
  );
...
function ChatHeader1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative" data-name="Chat Header">
      <Media10 />
    </div>
  );
}
...
function ChatHeader() {
  return (
    <div className="bg-white relative rounded-tl-[10px] rounded-tr-[10px] shrink-0 w-full" data-name="Chat Header">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none rounded-tl-[10px] rounded-tr-[10px]" />
      <div className="flex flex-row items-center size-full">
...
function ChatMessageHeader() {
  return (
    <div className="content-stretch flex gap-[8px] items-center not-italic relative shrink-0 whitespace-nowrap" data-name="Chat Message Header">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] relative shrink-0 text-[#0a1b39] text-[16px]">Mark Villiams</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#6c7688] text-[13px]">8:16 PM</p>
    </div>
  );
}
...
function Mention() {
  return (
    <div className="content-stretch flex items-center justify-center relative rounded-[4px] shrink-0" data-name="Mention">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#2e37a4] text-[14px] whitespace-nowrap">@Dr. Horace Keene</p>
    </div>
  );
}

function ChatMessageMention() {
  return (
    <div className="content-stretch flex gap-[5px] items-center relative shrink-0" data-name="Chat Message Mention">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">{`Hello `}</p>
      <Mention />
    </div>
  );
}
...
function ChatMessageText() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start justify-center min-w-px relative" data-name="Chat Message Text">
      <ChatMessageMention />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] min-w-full not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-[min-content]">Doctor, I’ve been feeling unwell. My blood pressure has been high for the past few days. Should I be worried?</p>
    </div>
  );
}
...
function ChatMessageContent() {
  return (
    <div className="bg-[#f5f6f8] relative rounded-bl-[6px] rounded-br-[6px] rounded-tr-[6px] shrink-0 w-full" data-name="Chat Message Content">
      <div className="flex flex-row items-center size-full">
...
function ChatMessageBody() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[481px]" data-name="Chat Message Body">
      <ChatMessageHeader />
      <ChatMessageContent />
    </div>
  );
...
function ChatMessage1() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0" data-name="Chat Message">
...
function ChatMessage() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Chat Message">
      <ChatMessage1 />
    </div>
  );
}
...
function ChatMessage2() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full" data-name="Chat Message">
      <div className="bg-white flex-[1_0_0] h-px min-w-px relative" data-name="Divider">
        <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-0 pointer-events-none" />
      </div>
      <div className="bg-[#2e37a4] content-stretch flex h-[20px] items-center justify-center px-[8px] py-[2px] relative rounded-[20px] shrink-0" data-name="Badge">
        <div className="flex flex-col font-['Instrument_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[12px] text-white whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          <p className="leading-[18px]">Today, March 28</p>
        </div>
      </div>
      <div className="bg-white flex-[1_0_0] h-px min-w-px relative" data-name="Divider">
        <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-0 pointer-events-none" />
...
function ChatMessageHeader1() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Chat Message Header">
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="Status Icon">
        <div className="absolute inset-[29.17%_8.33%_29.17%_29.17%]" data-name="Vector">
          <div className="absolute inset-[-8.57%_-5.71%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.75 6.83333">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">8:16 PM</p>
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[#0a1b39] text-[16px] whitespace-nowrap">Horace Keene</p>
    </div>
  );
}

function ChatMessageContent1() {
  return (
    <div className="bg-[#030303] content-stretch flex flex-col items-end justify-center p-[12px] relative rounded-bl-[6px] rounded-br-[6px] rounded-tl-[6px] shrink-0 w-[454px]" data-name="Chat Message Content">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[14px] text-white w-full">Can you share your recent readings? Also, have you experienced dizziness, headaches, or chest discomfort?</p>
    </div>
  );
}

function ChatMessageBody1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-end relative shrink-0 w-[487px]" data-name="Chat Message Body">
      <ChatMessageHeader1 />
      <ChatMessageContent1 />
    </div>
  );
...
function ChatMessage4() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-[535px]" data-name="Chat Message">
      <ChatMessageBody1 />
      <div className="relative shrink-0 size-[40px]" data-name="Avatar Circle">
...
function ChatMessage3() {
  return (
    <div className="content-stretch flex items-start justify-end relative shrink-0 w-full" data-name="Chat Message">
      <ChatMessage4 />
    </div>
  );
}

function ChatMessageHeader2() {
  return (
    <div className="content-stretch flex gap-[10px] items-center not-italic relative shrink-0 whitespace-nowrap" data-name="Chat Message Header">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] relative shrink-0 text-[#0a1b39] text-[16px]">Mark Villiams</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] relative shrink-0 text-[#6c7688] text-[13px]">8:16 PM</p>
    </div>
  );
...
function Text() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-center min-w-px relative" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">My readings were 140/90 and 145/92. No headaches, but I feel fatigued.</p>
    </div>
  );
}

function ChatMessageContent2() {
  return (
    <div className="bg-[#f5f6f8] relative rounded-bl-[6px] rounded-br-[6px] rounded-tr-[6px] shrink-0 w-full" data-name="Chat Message Content">
      <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-0 pointer-events-none rounded-bl-[6px] rounded-br-[6px] rounded-tr-[6px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[12px] relative size-full">
          <Text />
        </div>
...
function ChatMessageBody2() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[485px]" data-name="Chat Message Body">
      <ChatMessageHeader2 />
      <ChatMessageContent2 />
    </div>
  );
...
function PlayerPlay() {
  return (
    <div className="content-stretch flex flex-col items-center pl-[10px] pr-[8px] py-[9px] relative shrink-0" data-name="Player Play">
      <div className="absolute left-[2px] size-[28px] top-[2px]" data-name="Play">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 28">
          <circle cx="14" cy="14" fill="var(--fill-0, #2E37A4)" id="Play" r="14" />
        </svg>
      </div>
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="Play Icon">
        <div className="absolute bottom-[12.5%] left-1/4 right-[12.5%] top-[12.5%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.75027 10.5003">
            <path d={svgPaths.p3170a4c0} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Waveform() {
  return (
    <div className="content-stretch flex gap-[4px] h-[32px] items-center py-[8px] relative shrink-0" data-name="Waveform">
      <div className="bg-white rounded-[1px] shrink-0 size-[2px]" data-name="Waveform" />
      <div className="bg-white h-[8px] rounded-[1px] shrink-0 w-[2px]" data-name="Waveform" />
      <div className="bg-white h-[14px] rounded-[1px] shrink-0 w-[2px]" data-name="Waveform" />
      <div className="bg-white h-[4px] rounded-[1px] shrink-0 w-[2px]" data-name="Waveform" />
      <div className="bg-white h-[16px] rounded-[1px] shrink-0 w-[2px]" data-name="Waveform" />
      <div className="bg-white h-[14px] rounded-[1px] shrink-0 w-[2px]" data-name="Waveform" />
      <div className="bg-[#f5f6f8] h-[10px] rounded-[1px] shrink-0 w-[2px]" data-name="Waveform" />
      <div className="bg-[#f5f6f8] h-[10px] opacity-66 rounded-[1px] shrink-0 w-[2px]" data-name="Waveform" />
      <div className="bg-[#f5f6f8] h-[10px] opacity-66 rounded-[1px] shrink-0 w-[2px]" data-name="Waveform" />
      <div className="bg-[#f5f6f8] h-[14px] opacity-66 rounded-[1px] shrink-0 w-[2px]" data-name="Waveform" />
      <div className="bg-[#f5f6f8] h-[10px] opacity-66 rounded-[1px] shrink-0 w-[2px]" data-name="Waveform" />
      <div className="bg-[#f5f6f8] h-[16px] opacity-66 rounded-[1px] shrink-0 w-[2px]" data-name="Waveform" />
      <div className="bg-[#f5f6f8] h-[10px] opacity-66 rounded-[1px] shrink-0 w-[2px]" data-name="Waveform" />
      <div className="bg-[#f5f6f8] h-[4px] opacity-66 rounded-[1px] shrink-0 w-[2px]" data-name="Waveform" />
      <div className="bg-[#f5f6f8] opacity-66 rounded-[1px] shrink-0 size-[2px]" data-name="Waveform" />
    </div>
  );
}
...
function AudioPlayer() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0" data-name="Audio Player">
      <PlayerPlay />
      <Waveform />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic opacity-66 relative shrink-0 text-[14px] text-white whitespace-nowrap">0:05</p>
    </div>
  );
}

function ChatMessageContent3() {
  return (
    <div className="bg-[#030303] content-stretch flex flex-col items-center justify-center p-[12px] relative rounded-bl-[6px] rounded-br-[6px] rounded-tl-[6px] shrink-0" data-name="Chat Message Content">
      <AudioPlayer />
    </div>
  );
}

function ChatMessageBody3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-end min-w-px relative" data-name="Chat Message Body">
      <ChatMessageHeader3 />
      <ChatMessageContent3 />
    </div>
  );
...
function Text1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-center min-w-px relative" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Okay, I’ll track my readings. If it stays high, should I schedule a visit?</p>
    </div>
  );
}

function ChatMessageContent4() {
  return (
    <div className="bg-[#f5f6f8] relative rounded-bl-[6px] rounded-br-[6px] rounded-tr-[6px] shrink-0 w-full" data-name="Chat Message Content">
      <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-0 pointer-events-none rounded-bl-[6px] rounded-br-[6px] rounded-tr-[6px]" />
      <div className="flex flex-row items-center size-full">
...
function ChatMessages2() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Chat Messages">
      <ChatMessage />
      <ChatMessage2 />
      <ChatMessage3 />
      <ChatMessage5 />
...
function ChatInputAction() {
  return (
    <div className="bg-[#030303] content-stretch flex items-center justify-center p-[8px] relative rounded-[100px] shrink-0" data-name="Chat Input Action">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="More Options Icon">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
          <g id="Vector" />
        </svg>
        <div className="absolute inset-[45.83%]" data-name="Vector">
          <div className="absolute inset-[-75%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3.33333 3.33333">
              <path d={svgPaths.p2ecb0100} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
        <div className="absolute bottom-[16.67%] left-[45.83%] right-[45.83%] top-3/4" data-name="Vector">
...
function ChatInputAction1() {
  return (
    <div className="content-stretch flex items-center justify-center p-[8px] relative rounded-[100px] shrink-0" data-name="Chat Input Action">
      <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-0 pointer-events-none rounded-[100px]" />
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Emoji Icon">
        <div className="absolute inset-[12.5%]" data-name="Vector">
          <div className="absolute inset-[-4.17%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13 13">
              <path d={svgPaths.pfb15700} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[41.67%_62.46%_58.33%_37.5%]" data-name="Vector">
          <div className="absolute inset-[-0.5px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.00667 1">
              <path d="M0.5 0.5H0.506667" id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[41.67%_37.46%_58.33%_62.5%]" data-name="Vector">
          <div className="absolute inset-[-0.5px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.00667 1">
              <path d="M0.5 0.5H0.506667" id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        ...
        <div className="absolute inset-[62.5%_39.58%_33.12%_39.58%]" data-name="Vector">
          <div className="absolute inset-[-71.39%_-15%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4.33333 1.70034">
              <path d={svgPaths.p34504b80} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      </div>
...
function ChatInputAction2() {
  return (
    <div className="content-stretch flex items-center justify-center p-[8px] relative rounded-[100px] shrink-0" data-name="Chat Input Action">
      <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-0 pointer-events-none rounded-[100px]" />
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Audio Icon">
        <div className="absolute inset-[8.33%_37.5%_45.83%_37.5%]" data-name="Vector">
          <div className="absolute inset-[-6.82%_-12.5%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 8.33333">
              <path d={svgPaths.p112c4200} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[41.67%_20.83%_29.17%_20.83%]" data-name="Vector">
          <div className="absolute inset-[-10.71%_-5.36%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.3333 5.66667">
              <path d={svgPaths.p1bb06280} id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[87.5%_33.33%_12.5%_33.33%]" data-name="Vector">
          <div className="absolute inset-[-0.5px_-9.37%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.33333 1">
              <path d="M0.5 0.5H5.83333" id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute bottom-[12.5%] left-1/2 right-1/2 top-[70.83%]" data-name="Vector">
          <div className="absolute inset-[-18.75%_-0.5px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 3.66667">
              <path d="M0.5 0.5V3.16667" id="Vector" stroke="var(--stroke-0, #6C7688)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      </div>
...
function ChatInputActions() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0" data-name="Chat Input Actions">
      <ChatInputAction />
      <ChatInputAction1 />
      <ChatInputAction2 />
    </div>
...
function Content() {
  return (
    <div className="bg-white flex-[1_0_0] h-full min-w-px relative rounded-[5px]" data-name="Content">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[15px] relative size-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[21px] min-w-px not-italic relative text-[#6c7688] text-[14px]">Type your message here...</p>
        </div>
      </div>
    </div>
  );
...
function ChatInputAction3() {
  return (
    <div className="bg-[#2e37a4] content-stretch flex items-center justify-center p-[8px] relative rounded-[5px] shrink-0" data-name="Chat Input Action">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Send Icon">
        <div className="absolute inset-[12.5%_12.5%_41.67%_41.67%]" data-name="Vector">
          <div className="absolute inset-[-6.82%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.33333 8.33333">
              <path d="M0.5 7.83333L7.83333 0.5" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[12.5%_12.5%_11.16%_11.16%]" data-name="Vector">
          <div className="absolute inset-[-4.09%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.2139 13.2139">
              <path d={svgPaths.p1fd48200} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      </div>
...
function ChatInput() {
  return (
    <div className="bg-white drop-shadow-[0px_4px_7px_rgba(238,238,238,0.25)] relative rounded-[10px] shrink-0 w-full" data-name="Chat Input">
      <div className="flex flex-row items-center size-full">
...
function ChatMessages1() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start overflow-clip relative shrink-0 w-full" data-name="Chat Messages">
      <ChatMessages2 />
      <ChatInput />
    </div>
  );
...
function ChatMessages() {
  return (
    <div className="bg-white relative rounded-bl-[10px] rounded-br-[10px] shrink-0 w-full" data-name="Chat Messages">
...
function ChatContainer1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative rounded-[6px]" data-name="Chat Container">
...
function ChatList() {
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full" data-name="Chat List">
      <ChatItem />
      <ChatContainer1 />
    </div>
  );
...
function ChatContainer() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[300px] top-[76px] w-[1116px]" data-name="Chat Container">
      <Header />
      <ChatList />
    </div>
  );
  ...
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Avatar Container">
      <div className="relative shrink-0 size-[32px]" data-name="Avatar Circle">
        <img alt="" className="absolute block inset-0 max-w-none size-full" height="32" src={imgAvatarCircle3} width="32" />
      </div>
          ...
          <div className="content-stretch flex gap-[8px] items-center px-[12px] py-[8px] relative size-full">
            <div className="overflow-clip relative shrink-0 size-[14px]" data-name="messages">
              <div className="absolute inset-[12.5%_12.5%_41.67%_41.67%]" data-name="Vector">
                <div className="absolute inset-[-7.79%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.41667 7.41668">
                    <path d={svgPaths.p3c307b80} id="Vector" stroke="var(--stroke-0, #2E37A4)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[41.67%_41.67%_12.5%_12.5%]" data-name="Vector">
                <div className="absolute inset-[-7.79%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.41667 7.41668">
                    <path d={svgPaths.p39a4ec00} id="Vector" stroke="var(--stroke-0, #2E37A4)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
            </div>
...
function SidebarScroll() {
  return (
    <div className="absolute content-stretch flex h-[1044px] items-start left-0 top-0" data-name="Sidebar  Scroll">
...
export default function Messages() {
  return (
    <div className="bg-[#f5f6f8] relative size-full" data-name="Messages">
      <Footer />
      <ChatContainer />
