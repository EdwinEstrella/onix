import svgPaths from "./svg-fcbs1tonaw";
import imgAvatarCircle from "./412ff9c6f1b9821bbb6a401fd1b2f4f864fe6cf6.png";
import imgAvatarCircle1 from "./a197685a198f71ea35bddb300f9bae20243910ee.png";
import imgAvatarCircle2 from "./9fe484c5c12dfc5d10b62d4bcd3a8b35247925b2.png";
import imgAvatarCircle3 from "./28bbc7cd426964a75118348133e74f026927716b.png";
import imgAvatarCircle4 from "./9d72538d68169a7c75e123d88bcf3219d260e7cf.png";
import imgAvatarCircle5 from "./f8327b9f7b2d6ec857a448aaf4896c7ef3f45e33.png";
import imgAvatarCircle6 from "./3be8093d8952c011cb11db5344873b3e8be1e644.png";
import imgAvatarCircle7 from "./0e8e24ddb76b262a3952db2a4a274e6cbe5b5b2a.png";
import imgAvatarCircle8 from "./38b0564b60a0f22ec9a502f3febc41d08415c6f1.png";
import imgAvatarCircle9 from "./5284f22ff4eabd99cd3aebf8ab993008e2b3b7df.png";
import imgAvatarCircle10 from "./e11f5284f9aaa3e4330ba42e90f83be1f5843642.png";

function Footer() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between px-[24px] py-[8px] right-0 top-[981px] w-[1164px]" data-name="Footer">
...
function ExpensesTitleContainer() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-[339px]" data-name="Expenses Title Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[24px] not-italic relative shrink-0 text-[#0a1b39] text-[20px] whitespace-nowrap">Transactions</p>
      <div className="bg-[#ecedf7] content-stretch flex h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
        ...
        <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#2e37a4] text-[13px] whitespace-nowrap">
          <p className="leading-[19.5px]">Total Transactions : 565</p>
        </div>
      </div>
    </div>
  );
...
function Dropdown() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Dropdown">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-full justify-center leading-[0] not-italic relative shrink-0 text-[#111827] text-[14px] w-[47px]">
        ...
        <div className="absolute bottom-[37.5%] left-1/4 right-1/4 top-[37.5%]" data-name="Vector">
          <div className="absolute inset-[-16.67%_-8.33%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7 4">
              <path d="M0.5 0.5L3.5 3.5L6.5 0.5" id="Vector" stroke="var(--stroke-0, #111827)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      </div>
...
function SortBy() {
  return (
    <div className="content-stretch flex gap-[8px] h-full items-center relative shrink-0" data-name="Sort By">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-full justify-center leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[14px] w-[57px]">
        <p className="leading-[21px]">{`Sort By : `}</p>
      </div>
      <Dropdown />
    </div>
  );
...
function FilterAndSortContainer() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0" data-name="Filter and Sort Container">
      ...
      <div className="bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex h-[32px] items-center px-[12px] py-[6px] relative rounded-[5px] shrink-0" data-name="Sort By Dropdown order">
        <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-[6px]" />
        <SortBy />
      </div>
    </div>
  );
...
function SearchAndFilterContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative" data-name="Search and Filter Container">
...
function ExpenseColumnHeader() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Expense Column Header">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">Transaction ID</p>
          </div>
        </div>
      </div>
    </div>
...
function ExpenseItemTextContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#TNX0025</p>
    </div>
  );
}
...
function ExpenseItem() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Expense Item">
...
function ExpenseItemContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Expense Item Container">
      <ExpenseItem />
    </div>
  );
}
...
function ExpenseRow() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Expense Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
...
function ExpenseItemTextContainer1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#TNX0024</p>
    </div>
  );
}
...
function ExpenseItem1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Expense Item">
      <ExpenseItemTextContainer1 />
    </div>
  );
}

function ExpenseItemContainer1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Expense Item Container">
      <ExpenseItem1 />
    </div>
...
function ExpenseRow1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Expense Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <ExpenseItemContainer1 />
        </div>
      </div>
    </div>
  );
...
function ExpenseItemTextContainer2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#TNX0023</p>
    </div>
  );
}
...
function ExpenseItem2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Expense Item">
      <ExpenseItemTextContainer2 />
    </div>
  );
}

function ExpenseItemContainer2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Expense Item Container">
      <ExpenseItem2 />
    </div>
...
function ExpenseRow2() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Expense Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <ExpenseItemContainer2 />
        </div>
      </div>
    </div>
  );
...
function ExpenseItem3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Expense Item">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#TNX0022</p>
    </div>
  );
}

function ExpenseRow3() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Expense Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
...
function ExpenseItemTextContainer3() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#TNX0021</p>
    </div>
  );
}

function ExpenseItem4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Expense Item">
      <ExpenseItemTextContainer3 />
    </div>
  );
}

function ExpenseItemContainer3() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Expense Item Container">
      <ExpenseItem4 />
    </div>
...
function ExpenseRow4() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Expense Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <ExpenseItemContainer3 />
        </div>
      </div>
    </div>
  );
...
function ExpenseItemTextContainer4() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#TNX0020</p>
    </div>
  );
}

function ExpenseItem5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Expense Item">
      <ExpenseItemTextContainer4 />
    </div>
  );
}

function ExpenseItemContainer4() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Expense Item Container">
      <ExpenseItem5 />
    </div>
...
function ExpenseRow5() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Expense Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <ExpenseItemContainer4 />
        </div>
      </div>
    </div>
  );
...
function ExpenseItemTextContainer5() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#TNX0019</p>
    </div>
  );
}

function ExpenseItem6() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Expense Item">
      <ExpenseItemTextContainer5 />
    </div>
  );
}

function ExpenseItemContainer5() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Expense Item Container">
      <ExpenseItem6 />
    </div>
...
function ExpenseRow6() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Expense Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <ExpenseItemContainer5 />
        </div>
      </div>
    </div>
  );
...
function ExpenseItemTextContainer6() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#TNX0018</p>
    </div>
  );
}

function ExpenseItem7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Expense Item">
      <ExpenseItemTextContainer6 />
    </div>
  );
}

function ExpenseItemContainer6() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Expense Item Container">
      <ExpenseItem7 />
    </div>
...
function ExpenseRow7() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Expense Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <ExpenseItemContainer6 />
        </div>
      </div>
    </div>
  );
...
function ExpenseItemTextContainer7() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#TNX0017</p>
    </div>
  );
}

function ExpenseItem8() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Expense Item">
      <ExpenseItemTextContainer7 />
    </div>
  );
}

function ExpenseItemContainer7() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Expense Item Container">
      <ExpenseItem8 />
    </div>
...
function ExpenseRow8() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Expense Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <ExpenseItemContainer7 />
        </div>
      </div>
    </div>
  );
...
function ExpenseItemTextContainer8() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Expense Item Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">#TNX0016</p>
    </div>
  );
}

function ExpenseItem9() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Expense Item">
      <ExpenseItemTextContainer8 />
    </div>
  );
}

function ExpenseItemContainer8() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Expense Item Container">
      <ExpenseItem9 />
    </div>
...
function ExpenseRow9() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Expense Row">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <ExpenseItemContainer8 />
        </div>
      </div>
    </div>
  );
...
function ExpenseRowsContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px relative w-full" data-name="Expense Rows Container">
      <ExpenseRow />
      <ExpenseRow1 />
      <ExpenseRow2 />
      <ExpenseRow3 />
...
function ExpenseColumnContainer() {
  return (
    <div className="content-stretch flex flex-col h-[695px] items-start relative shrink-0 w-[142px]" data-name="Expense Column Container">
      <ExpenseColumnHeader />
      <ExpenseRowsContainer />
    </div>
  );
}
...
function ColumnHeader() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Column Header">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
...
function RowText() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full" data-name="Row Text">
...
function RowTextContainer() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Row Text Container">
      <RowText />
    </div>
  );
}
...
function RowContent() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Row Content">
...
function Row() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <RowContent />
...
function RowText1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Row Text">
...
function RowTextContainer3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Row Text Container">
      <RowText3 />
    </div>
  );
}
...
function RowText2() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Row Text">
      <RowTextContainer3 />
    </div>
  );
}

function RowTextContainer2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Row Text Container">
      <RowText2 />
    </div>
...
function Container() {
  return (
    <div className="content-stretch flex flex-col h-[695px] items-start relative shrink-0 w-[206px]" data-name="Container">
      <ColumnHeader />
      <Container1 />
    </div>
  );
...
function RowTextContainer15() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Row Text Container">
...
function RowText14() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Row Text">
      <RowTextContainer15 />
    </div>
  );
}

function RowTextContainer14() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Row Text Container">
      <RowText14 />
    </div>
  );
}
...
function RowTextContainer17() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Row Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Dental Cleaning</p>
    </div>
  );
}
...
function RowTextContainer19() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Row Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Eye Checkup</p>
    </div>
  );
}
...
function RowTextContainer21() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Row Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">X-Ray</p>
    </div>
  );
}
...
function RowTextContainer23() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Row Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Physiotherapy Session</p>
    </div>
  );
}
...
function RowTextContainer25() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Row Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Cardiac Screening</p>
    </div>
  );
}
...
function RowTextContainer27() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Row Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Skin Allergy Test</p>
    </div>
  );
}
...
function RowTextContainer32() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Row Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Nutrition Counseling</p>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[207px]" data-name="Container">
      <ColumnHeader1 />
      <Container3 />
    </div>
  );
...
function DateColumnHeader() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Date Column Header">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
            <p className="leading-[21px] whitespace-pre">{`Paid  Date`}</p>
          </div>
        </div>
      </div>
    </div>
...
function DateItem() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Date Item">
...
function DateItemContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Date Item Container">
      <DateItem />
    </div>
  );
}
...
function DateRow() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Date Row">
      <DateItemContainer />
    </div>
  );
}

function DateRowsContainer() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Date Rows Container">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <DateRow />
...
function DateItemText() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Date Item Text">
...
function DateItem1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Date Item">
      <DateItemText />
    </div>
  );
}

function DateItemContainer1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Date Item Container">
      <DateItem1 />
    </div>
  );
}
...
function DateRow1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Date Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <DateItemContainer1 />
...
function DateItem3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Date Item">
...
function DateColumnContainer1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px relative w-full" data-name="Date Column Container">
      <DateRowsContainer />
      <DateRow1 />
      <DateRow2 />
      <DateRow3 />
...
function DateColumnContainer() {
  return (
    <div className="content-stretch flex flex-col h-[695px] items-start relative shrink-0 w-[133px]" data-name="Date Column Container">
      <DateColumnHeader />
...
function PaymentMethodColumnHeader() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Payment Method Column Header">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
...
function PaymentMethodItemText() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Payment Method Item Text">
...
function PaymentMethodItem() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Payment Method Item">
...
function PaymentMethodRow() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Payment Method Row">
      <PaymentMethodItem />
    </div>
  );
}

function PaymentMethodRowsContainer() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Payment Method Rows Container">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <PaymentMethodRow />
...
function PaymentMethodItemText2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Payment Method Item Text">
...
function PaymentMethodItemText1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Payment Method Item Text">
      <PaymentMethodItemText2 />
    </div>
  );
}

function PaymentMethodItem1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Payment Method Item">
      <PaymentMethodItemText1 />
    </div>
  );
}

function PaymentMethodRow1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Payment Method Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <PaymentMethodItem1 />
...
function PaymentMethodItemText4() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Payment Method Item Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Debit Card</p>
    </div>
...
function PaymentMethodItemText3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Payment Method Item Text">
      <PaymentMethodItemText4 />
    </div>
  );
}

function PaymentMethodItem2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Payment Method Item">
      <PaymentMethodItemText3 />
    </div>
  );
}

function PaymentMethodRow2() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Payment Method Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
...
function PaymentMethodItemText6() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Payment Method Item Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">PayPal</p>
    </div>
...
function PaymentMethodItemText5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Payment Method Item Text">
      <PaymentMethodItemText6 />
    </div>
  );
}

function PaymentMethodItem3() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Payment Method Item">
      <PaymentMethodItemText5 />
    </div>
  );
}

function PaymentMethodRow3() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Payment Method Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
...
function PaymentMethodItem4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Payment Method Item">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Cheque</p>
    </div>
  );
}

function PaymentMethodRow4() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Payment Method Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
...
function PaymentMethodItemText8() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Payment Method Item Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Debit Card</p>
    </div>
...
function PaymentMethodItemText7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Payment Method Item Text">
      <PaymentMethodItemText8 />
    </div>
  );
}

function PaymentMethodItem5() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Payment Method Item">
      <PaymentMethodItemText7 />
    </div>
  );
}

function PaymentMethodRow5() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Payment Method Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
...
function PaymentMethodItemText10() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Payment Method Item Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Cheque</p>
    </div>
...
function PaymentMethodItemText9() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Payment Method Item Text">
      <PaymentMethodItemText10 />
    </div>
  );
}

function PaymentMethodItem6() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Payment Method Item">
      <PaymentMethodItemText9 />
    </div>
  );
}

function PaymentMethodRow6() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Payment Method Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
...
function PaymentMethodItemText12() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Payment Method Item Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Debit Card</p>
    </div>
...
function PaymentMethodItemText11() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Payment Method Item Text">
      <PaymentMethodItemText12 />
    </div>
  );
}

function PaymentMethodItem7() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Payment Method Item">
      <PaymentMethodItemText11 />
    </div>
  );
}

function PaymentMethodRow7() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Payment Method Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
...
function PaymentMethodItemText14() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Payment Method Item Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">PayPal</p>
    </div>
...
function PaymentMethodItemText13() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Payment Method Item Text">
      <PaymentMethodItemText14 />
    </div>
  );
}

function PaymentMethodItem8() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Payment Method Item">
      <PaymentMethodItemText13 />
    </div>
  );
}

function PaymentMethodRow8() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Payment Method Row">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
...
function PaymentMethodColumnContainer1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px relative w-full" data-name="Payment Method Column Container">
      <PaymentMethodRowsContainer />
      <PaymentMethodRow1 />
      <Row20 />
      <PaymentMethodRow2 />
      <PaymentMethodRow3 />
...
function PaymentMethodColumnContainer() {
  return (
    <div className="content-stretch flex flex-col h-[695px] items-start relative shrink-0 w-[142px]" data-name="Payment Method Column Container">
      <PaymentMethodColumnHeader />
      <PaymentMethodColumnContainer1 />
    </div>
  );
}
...
function RowTextContainer36() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Row Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">$200</p>
    </div>
  );
}
...
function RowTextContainer38() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Row Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">$180</p>
    </div>
  );
}
...
function RowTextContainer40() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Row Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">$150</p>
    </div>
  );
}
...
function RowTextContainer42() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[100px]" data-name="Row Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">$80</p>
    </div>
  );
}
...
function RowTextContainer41() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[107px]" data-name="Row Text Container">
      <RowText27 />
    </div>
  );
}
...
function RowTextContainer44() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[100px]" data-name="Row Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">$130</p>
    </div>
  );
}
...
function RowTextContainer46() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[100px]" data-name="Row Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">$300</p>
    </div>
  );
}
...
function RowTextContainer48() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[100px]" data-name="Row Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">$220</p>
    </div>
  );
}
...
function RowTextContainer52() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[100px]" data-name="Row Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">$230</p>
    </div>
  );
}
...
function RowTextContainer54() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Row Text Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">$250</p>
    </div>
  );
}
...
function RowText33() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[130px]" data-name="Row Text">
      <RowTextContainer54 />
    </div>
  );
}

function RowTextContainer53() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Row Text Container">
      <RowText33 />
    </div>
...
function Container4() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[123px]" data-name="Container">
      <ColumnHeader2 />
      <Container5 />
    </div>
  );
...
function StatusColumnHeader() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Status Column Header">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
...
function StatusRowsContainer() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Status Rows Container">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="bg-[#f4fbf7] content-stretch flex h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            ...
            <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#27ae60] text-[13px] whitespace-nowrap">
              <p className="leading-[19.5px]">Completed</p>
            </div>
          </div>
        </div>
      </div>
...
function StatusRow() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Status Row">
      <div aria-hidden="true" className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
...
function StatusColumnContainer1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px relative w-full" data-name="Status Column Container">
      <StatusRowsContainer />
      <StatusRow />
      <StatusRow1 />
      <StatusRow2 />
...
function StatusColumnContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[695px] items-start min-w-px relative" data-name="Status Column Container">
      <StatusColumnHeader />
      <StatusColumnContainer1 />
    </div>
  );
}
...
function TableContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Table Container">
      <div aria-hidden="true" className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none" />
      <ExpenseColumnContainer />
      <Container />
      <div className="flex flex-row items-center self-stretch">
        <Container2 />
      </div>
      <DateColumnContainer />
      <PaymentMethodColumnContainer />
      <div className="flex flex-row items-center self-stretch">
        <Container4 />
      </div>
    ...
    <div className="relative shrink-0 size-[32px]" data-name="Number">
      <div className="absolute inset-[-1.56%_-4.69%_-7.81%_-4.69%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 35 35">
          <g filter="url(#filter0_d_5_156829)" id="Number">
          ...
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="35" id="filter0_d_5_156829" width="35" x="0" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_5_156829" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_5_156829" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
...
function TransactionContainer() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[300px] top-[76px] w-[1116px]" data-name="Transaction Container">
      <HeaderContainer />
      <TableContainer />
      <div className="content-stretch flex gap-[20px] items-center relative shrink-0 w-full" data-name="Pagination Container">
        <ResultCounts />
              ...
              <div className="absolute bottom-[12.5%] left-3/4 right-[12.5%] top-[12.5%]" data-name="Vector">
                <div className="absolute inset-[-4.76%_-28.57%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2.75 11.5">
                    <path d={svgPaths.pe6cc600} id="Vector" stroke="var(--stroke-0, #2E37A4)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[12.5%_62.5%_12.5%_12.5%]" data-name="Vector">
                <div className="absolute inset-[-4.76%_-14.29%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4.5 11.5">
                    <path d={svgPaths.p5468d00} id="Vector" stroke="var(--stroke-0, #2E37A4)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute bottom-1/2 left-[37.5%] right-[29.17%] top-1/2" data-name="Vector">
                <div className="absolute inset-[-0.5px_-10.71%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.66667 1">
                    <path d="M0.5 0.5H5.16667" id="Vector" stroke="var(--stroke-0, #2E37A4)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[37.5%_29.17%_37.5%_58.33%]" data-name="Vector">
                <div className="absolute inset-[-14.29%_-28.57%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2.75 4.5">
                    <path d="M0.5 4L2.25 2.25L0.5 0.5" id="Vector" stroke="var(--stroke-0, #2E37A4)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
            </div>
...
export default function Transactions() {
  return (
    <div className="bg-[#f5f6f8] relative size-full" data-name="Transactions">
      <Footer />
